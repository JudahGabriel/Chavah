...
{
    /// <summary>
    /// A donation with related artist information. Some artists have their donations go to other artists via <see cref="Artist.DonationRecipientId"/>.
    /// For example, Jamie Hilsden has his donations go to his band, Miqedem.
