...
{
    [RequireHttps]
    public class LegacyAccountController : RavenController
    {
        ...
        public LegacyAccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
