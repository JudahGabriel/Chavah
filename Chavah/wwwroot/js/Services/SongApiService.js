...
(function (BitShuva) {
    ...
    (function (Chavah) {
        var SongApiService = /** @class */ (function () {
            function SongApiService(httpApi, $q) {
            ...
            SongApiService.prototype.getSongByArtistId = function (artistId) {
                var url = "/api/songs/getByArtistId/";
                var args = {
                    artistId: artistId
                };
                return this.httpApi.query(url, args, SongApiService.songOrNullConverter);
            ...
            SongApiService.prototype.getRandomPopular = function (count) {
                var args = {
                    count: count,
                };
                return this.httpApi.query("/api/songs/getRandomPopular", args, SongApiService.songListConverter);
            };
            SongApiService.prototype.getPopular = function (skip, take) {
                var args = {
                    skip: skip,
                    take: take
                };
            ...
            SongApiService.prototype.songFailed = function (error) {
                return this.httpApi.postUriEncoded("/api/songs/recordAudioError", error);
            };
            ...
            SongApiService.prototype.getRandomNewSongs = function (count) {
                var args = {
                    count: count
                };
