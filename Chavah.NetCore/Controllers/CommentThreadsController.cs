...
namespace BitShuva.Chavah.Controllers
{
    ...
    public class CommentThreadsController : RavenController
    {
        ...
        {
            var thread = await DbSession.LoadOptionAsync<CommentThread>(id);
            ...
            return thread.ValueOr(() => new CommentThread
            {
                Id = id,
        ...
        public async Task<CommentThread> AddComment([FromBody]AddComment commentInfo)
        {
            ...
            var commentThread = await DbSession.LoadOptionAsync<CommentThread>(commentThreadId)
                .ToAsyncOption()
                .ValueOr(() =>
                {
