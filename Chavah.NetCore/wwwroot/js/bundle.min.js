...
/**
	 ...
	 */
function n(t,r){function h(n,t){return function(){return n.apply(t,arguments)}}var o,f,e,u,s;if(r=r||{},this.trackingClick=!1,this.trackingClickStart=0,this.targetElement=null,this.touchStartX=0,this.touchStartY=0,this.lastTouchIdentifier=0,this.touchBoundary=r.touchBoundary||10,this.layer=t,this.tapDelay=r.tapDelay||200,this.tapTimeout=r.tapTimeout||700,!n.notNeeded(t)){for(f=["onMouse","onClick","onTouchStart","onTouchMove","onTouchEnd","onTouchCancel"],e=this,u=0,s=f.length;u<s;u++)e[f[u]]=h(e[f[u]],e);i&&(t.addEventListener("mouseover",this.onMouse,!0),t.addEventListener("mousedown",this.onMouse,!0),t.addEventListener("mouseup",this.onMouse,!0));t.addEventListener("click",this.onClick,!0);t.addEventListener("touchstart",this.onTouchStart,!1);t.addEventListener("touchmove",this.onTouchMove,!1);t.addEventListener("touchend",this.onTouchEnd,!1);t.addEventListener("touchcancel",this.onTouchCancel,!1);Event.prototype.stopImmediatePropagation||(t.removeEventListener=function(n,i,r){var u=Node.prototype.removeEventListener;n==="click"?u.call(t,n,i.hijacked||i,r):u.call(t,n,i,r)},t.addEventListener=function(n,i,r){var u=Node.prototype.addEventListener;n==="click"?u.call(t,n,i.hijacked||(i.hijacked=function(n){n.propagationStopped||i(n)}),r):u.call(t,n,i,r)});typeof t.onclick=="function"&&(o=t.onclick,t.addEventListener("click",function(n){o(n)},!1),t.onclick=null)}}var r=navigator.userAgent.indexOf("Windows Phone")>=0,i=navigator.userAgent.indexOf("Android")>0&&!r,t=/iP(ad|hone|od)/.test(navigator.userAgent)&&!r,u=t&&/OS 4_\d(_\d)?/.test(navigator.userAgent),f=t&&/OS [6-7]_\d/.test(navigator.userAgent),e=navigator.userAgent.indexOf("BB10")>0;n.prototype.needsClick=function(n){switch(n.nodeName.toLowerCase()){case"button":case"select":case"textarea":if(n.disabled)return!0;break;case"input":if(t&&n.type==="file"||n.disabled)return!0;break;case"label":case"iframe":case"video":return!0}return/\bneedsclick\b/.test(n.className)};n.prototype.needsFocus=function(n){switch(n.nodeName.toLowerCase()){case"textarea":return!0;case"select":return!i;case"input":switch(n.type){case"button":case"checkbox":case"file":case"image":case"radio":case"submit":return!1}return!n.disabled&&!n.readOnly;default:return/\bneedsfocus\b/.test(n.className)}};n.prototype.sendClick=function(n,t){var r,i;document.activeElement&&document.activeElement!==n&&document.activeElement.blur();i=t.changedTouches[0];r=document.createEvent("MouseEvents");r.initMouseEvent(this.determineEventType(n),!0,!0,window,1,i.screenX,i.screenY,i.clientX,i.clientY,!1,!1,!1,!1,0,null);r.forwardedTouchEvent=!0;n.dispatchEvent(r)};n.prototype.determineEventType=function(n){return i&&n.tagName.toLowerCase()==="select"?"mousedown":"click"};n.prototype.focus=function(n){var i;t&&n.setSelectionRange&&n.type.indexOf("date")!==0&&n.type!=="time"&&n.type!=="month"?(i=n.value.length,n.setSelectionRange(i,i)):n.focus()};n.prototype.updateScrollParent=function(n){var i,t;if(i=n.fastClickScrollParent,!i||!i.contains(n)){t=n;do{if(t.scrollHeight>t.offsetHeight){i=t;n.fastClickScrollParent=t;break}t=t.parentElement}while(t)}i&&(i.fastClickLastScrollTop=i.scrollTop)};n.prototype.getTargetElementFromEventTarget=function(n){return n.nodeType===Node.TEXT_NODE?n.parentNode:n};n.prototype.onTouchStart=function(n){var r,i,f;if(n.targetTouches.length>1)return!0;if(r=this.getTargetElementFromEventTarget(n.target),i=n.targetTouches[0],t){if(f=window.getSelection(),f.rangeCount&&!f.isCollapsed)return!0;if(!u){if(i.identifier&&i.identifier===this.lastTouchIdentifier)return n.preventDefault(),!1;this.lastTouchIdentifier=i.identifier;this.updateScrollParent(r)}}return this.trackingClick=!0,this.trackingClickStart=n.timeStamp,this.targetElement=r,this.touchStartX=i.pageX,this.touchStartY=i.pageY,n.timeStamp-this.lastClickTime<this.tapDelay&&n.preventDefault(),!0};n.prototype.touchHasMoved=function(n){var t=n.changedTouches[0],i=this.touchBoundary;return Math.abs(t.pageX-this.touchStartX)>i||Math.abs(t.pageY-this.touchStartY)>i?!0:!1};n.prototype.onTouchMove=function(n){return this.trackingClick?((this.targetElement!==this.getTargetElementFromEventTarget(n.target)||this.touchHasMoved(n))&&(this.trackingClick=!1,this.targetElement=null),!0):!0};n.prototype.findControl=function(n){return n.control!==undefined?n.control:n.htmlFor?document.getElementById(n.htmlFor):n.querySelector("button, input:not([type=hidden]), keygen, meter, output, progress, select, textarea")};n.prototype.onTouchEnd=function(n){var s,c,e,o,h,r=this.targetElement;if(!this.trackingClick)return!0;if(n.timeStamp-this.lastClickTime<this.tapDelay)return this.cancelNextClick=!0,!0;if(n.timeStamp-this.trackingClickStart>this.tapTimeout)return!0;if(this.cancelNextClick=!1,this.lastClickTime=n.timeStamp,c=this.trackingClickStart,this.trackingClick=!1,this.trackingClickStart=0,f&&(h=n.changedTouches[0],r=document.elementFromPoint(h.pageX-window.pageXOffset,h.pageY-window.pageYOffset)||r,r.fastClickScrollParent=this.targetElement.fastClickScrollParent),e=r.tagName.toLowerCase(),e==="label"){if(s=this.findControl(r),s){if(this.focus(r),i)return!1;r=s}}else if(this.needsFocus(r))return n.timeStamp-c>100||t&&window.top!==window&&e==="input"?(this.targetElement=null,!1):(this.focus(r),this.sendClick(r,n),t&&e==="select"||(this.targetElement=null,n.preventDefault()),!1);return t&&!u&&(o=r.fastClickScrollParent,o&&o.fastClickLastScrollTop!==o.scrollTop)?!0:(this.needsClick(r)||(n.preventDefault(),this.sendClick(r,n)),!1)};n.prototype.onTouchCancel=function(){this.trackingClick=!1;this.targetElement=null};n.prototype.onMouse=function(n){return this.targetElement?n.forwardedTouchEvent?!0:n.cancelable?!this.needsClick(this.targetElement)||this.cancelNextClick?(n.stopImmediatePropagation?n.stopImmediatePropagation():n.propagationStopped=!0,n.stopPropagation(),n.preventDefault(),!1):!0:!0:!0};n.prototype.onClick=function(n){var t;return this.trackingClick?(this.targetElement=null,this.trackingClick=!1,!0):n.target.type==="submit"&&n.detail===0?!0:(t=this.onMouse(n),t||(this.targetElement=null),t)};n.prototype.destroy=function(){var n=this.layer;i&&(n.removeEventListener("mouseover",this.onMouse,!0),n.removeEventListener("mousedown",this.onMouse,!0),n.removeEventListener("mouseup",this.onMouse,!0));n.removeEventListener("click",this.onClick,!0);n.removeEventListener("touchstart",this.onTouchStart,!1);n.removeEventListener("touchmove",this.onTouchMove,!1);n.removeEventListener("touchend",this.onTouchEnd,!1);n.removeEventListener("touchcancel",this.onTouchCancel,!1)};n.notNeeded=function(n){var t,r,u,f;if(typeof ontouchstart=="undefined")return!0;if(r=+(/Chrome\/([0-9]+)/.exec(navigator.userAgent)||[,0])[1],r)if(i){if(t=document.querySelector("meta[name=viewport]"),t&&(t.content.indexOf("user-scalable=no")!==-1||r>31&&document.documentElement.scrollWidth<=window.outerWidth))return!0}else return!0;return e&&(u=navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/),u[1]>=10&&u[2]>=3&&(t=document.querySelector("meta[name=viewport]"),t&&(t.content.indexOf("user-scalable=no")!==-1||document.documentElement.scrollWidth<=window.outerWidth)))?!0:n.style.msTouchAction==="none"||n.style.touchAction==="manipulation"?!0:(f=+(/Firefox\/([0-9]+)/.exec(navigator.userAgent)||[,0])[1],f>=27&&(t=document.querySelector("meta[name=viewport]"),t&&(t.content.indexOf("user-scalable=no")!==-1||document.documentElement.scrollWidth<=window.outerWidth)))?!0:n.style.touchAction==="none"||n.style.touchAction==="manipulation"?!0:!1};n.attach=function(t,i){return new n(t,i)};typeof define=="function"&&typeof define.amd=="object"&&define.amd?define(function(){return n}):typeof module!="undefined"&&module.exports?(module.exports=n.attach,module.exports.FastClick=n):window.FastClick=n}(),function(n){function pi(n){return n&&n.Object===Object?n:null}function ft(n){for(var i=n.length,r=new Array(i),t=0;t<i;t++)r[t]=n[t];return r}function ih(n){return function(){try{return n.apply(this,arguments)}catch(t){return u.e=t,u}}}function rt(n){throw n;}function rh(n,t){var r,i,u;if(ci&&t.stack&&typeof n=="object"&&n!==null&&n.stack&&n.stack.indexOf(cr)===-1){for(r=[],i=t;!!i;i=i.source)i.stack&&r.unshift(i.stack);r.unshift(n.stack);u=r.join("\n"+cr+"\n");n.stack=uh(u)}}function uh(n){for(var t,r=n.split("\n"),u=[],i=0,f=r.length;i<f;i++)t=r[i],fh(t)||eh(t)||!t||u.push(t);return u.join("\n")}function fh(n){var t=cu(n),r,i;return t?(r=t[0],i=t[1],r===su&&i>=ou&&i<=ks):!1}function eh(n){return n.indexOf("(module.js:")!==-1||n.indexOf("(node.js:")!==-1}function hu(){if(ci)try{throw new Error;}catch(i){var n=i.stack.split("\n"),r=n[0].indexOf("@")>0?n[1]:n[2],t=cu(r);return t?(su=t[0],t[1]):void 0}}function cu(n){var r=/at .+ \((.+):(\d+):(?:\d+)\)$/.exec(n),t,i;return r?[r[1],Number(r[2])]:(t=/at ([^ ]+):(\d+):(?:\d+)$/.exec(n),t)?[t[1],Number(t[2])]:(i=/.*@(.+):(\d+)$/.exec(n),i?[i[1],Number(i[2])]:void 0)}function sh(t,i,r,u,f,e){var a=gu(t),v=a.length,b=gu(i),k=b.length,s,o,l,y,p,w,h,c;if(v!==k&&!u)return!1;for(s=v;s--;)if(o=a[s],!(u?o in i:vr.call(i,o)))return!1;for(l=u;++s<v;){if(o=a[s],y=t[o],p=i[o],!(w===n?r(y,p,u,f,e):w))return!1;l||(l=o==="constructor")}return!l&&(h=t.constructor,c=i.constructor,h!==c&&"constructor"in t&&"constructor"in i&&!(typeof h=="function"&&h instanceof h&&typeof c=="function"&&c instanceof c))?!1:!0}function hh(n,t,i){switch(i){case vu:case yu:return+n==+t;case pu:return n.name===t.name&&n.message===t.message;case wu:return n!==+n?t!==+t:n===+t;case bu:case ku:return n===t+""}return!1}function yr(n){return!!n&&typeof n=="object"}function tf(n){return typeof n=="number"&&n>-1&&n%1==0&&n<=oh}function ch(n){return yr(n)&&tf(n.length)&&!!a[gi.call(n)]}function lh(n,t){for(var i=-1,r=n.length;++i<r;)if(t(n[i],i,n))return!0;return!1}function ah(t,i,r,u,f,e){var s=-1,h=t.length,l=i.length,o,c,a;if(h!==l&&!(u&&l>h))return!1;while(++s<h){if(o=t[s],c=i[s],a!==n){if(a)continue;return!1}if(u){if(!lh(i,function(n){return o===n||r(o,n,u,f,e)}))return!1}else if(!(o===c||r(o,c,u,f,e)))return!1}return!0}function vh(n,t,i,r,u,f){var s=wr(n),p=wr(t),e=di,o=di,c,l,h,y;s||(e=gi.call(n),e===ar?e=ii:e!==ii&&(s=ch(n)));p||(o=gi.call(t),o===ar&&(o=ii));var a=e===ii&&!pr(n),w=o===ii&&!pr(t),v=e===o;if(v&&!(s||a))return hh(n,t,e);if(!r&&(c=a&&vr.call(n,"__wrapped__"),l=w&&vr.call(t,"__wrapped__"),c||l))return i(c?n.value():n,l?t.value():t,r,u,f);if(!v)return!1;for(u||(u=[]),f||(f=[]),h=u.length;h--;)if(u[h]===n)return f[h]===t;return u.push(n),f.push(t),y=(s?ah:sh)(n,t,i,r,u,f),u.pop(),f.pop(),y}function rf(n,t,i,r,u){return n===t?!0:n==null||t==null||!nf(n)&&!yr(t)?n!==n&&t!==t:vh(n,t,rf,i,r,u)}function gt(n,t){for(var r=new Array(n),i=0;i<n;i++)r[i]=t();return r}function sf(n,t){this.id=n;this.value=t}function tr(n){this._s=n;this.isDisposed=!1}function pf(n){this._s=n}function nu(n){this._s=n;this._l=n.length;this._i=0}function wf(n){this._a=n}function tu(n){this._a=n;this._l=bc(n);this._i=0}function yc(n){return typeof n=="number"&&l.isFinite(n)}function pc(t){var r=t[g],i;if(!r&&typeof t=="string")return i=new pf(t),i[g]();if(!r&&t.length!==n)return i=new wf(t),i[g]();if(!r)throw new TypeError("Object is not iterable");return t[g]()}function wc(n){var t=+n;return t===0?t:isNaN(t)?t:t<0?-1:1}function bc(n){var t=+n.length;return isNaN(t)?0:t===0||!yc(t)?t:(t=wc(t)*Math.floor(Math.abs(t)),t<=0)?0:t>yf?yf:t}function bf(n,t){return v(n)||(n=tt),new ir(t,n)}function ne(n,t){this.observer=n;this.parent=t}function vi(){return!1}function rr(){for(var t=arguments.length,i=new Array(t),n=0;n<t;n++)i[n]=arguments[n];return i}function vi(){return!1}function rr(){for(var t=arguments.length,i=new Array(t),n=0;n<t;n++)i[n]=arguments[n];return i}function vi(){return!1}function ae(){return[]}function vi(){return!1}function ae(){return[]}function rr(){for(var t=arguments.length,i=new Array(t),n=0;n<t;n++)i[n]=arguments[n];return i}function kl(n){return function(t){return n.subscribe(t)}}function dl(t,i){return function(r){for(var e,u=r,f=0;f<i;f++)if(e=u[t[f]],typeof e!="undefined")u=e;else return n;return u}}function gl(n,t,i,r){var u=new er;return r.push(na(u,t,i)),n.apply(t,r),u.asObservable()}function na(n,t,i){return function(){for(var e=arguments.length,r=new Array(e),f=0;f<e;f++)r[f]=arguments[f];if(c(i)){if(r=o(i).apply(t,r),r===u)return n.onError(r.e);n.onNext(r)}else if(r.length<=1)n.onNext(r[0]);else n.onNext(r);n.onCompleted()}}function ta(n,t,i,r){var u=new er;return r.push(ia(u,t,i)),n.apply(t,r),u.asObservable()}function ia(n,t,i){return function(){var e=arguments[0],s,f,r;if(e)return n.onError(e);for(s=arguments.length,r=[],f=1;f<s;f++)r[f-1]=arguments[f];if(c(i)){if(r=o(i).apply(t,r),r===u)return n.onError(r.e);n.onNext(r)}else if(r.length<=1)n.onNext(r[0]);else n.onNext(r);n.onCompleted()}}function ra(n){return l.StaticNodeList?n instanceof l.StaticNodeList||n instanceof l.NodeList:Object.prototype.toString.call(n)==="[object NodeList]"}function wo(n,t,i){this._e=n;this._n=t;this._fn=i;this._e.addEventListener(this._n,this._fn,!1);this.isDisposed=!1}function bo(n,t,i){var u=new ct,e=Object.prototype.toString.call(n),r,f;if(ra(n)||e==="[object HTMLCollection]")for(r=0,f=n.length;r<f;r++)u.add(bo(n.item(r),t,i));else n&&u.add(new wo(n,t,i));return u}function ha(n,t){return new sa(n,t)}function ts(n,t,i){return new d(function(r){var u=n,f=ff(t);return i.scheduleRecursiveFuture(0,u,function(n,t){if(f>0){var e=i.now();u=new Date(u.getTime()+f);u.getTime()<=e&&(u=new Date(e+f))}r.onNext(n);t(n+1,new Date(u))})})}function is(n,t,i){return n===t?new d(function(n){return i.schedulePeriodic(0,t,function(t){n.onNext(t);return t+1})}):af(function(){return ts(new Date(i.now()+n),t,i)})}function us(n,t,i){return new d(function(r){var e=!1,s=new w,f=null,u=[],o=!1,c;return c=n.materialize().timestamp(i).subscribe(function(n){var c,l;if(n.value.kind==="E"?(u=[],u.push(n),f=n.value.error,l=!o):(u.push({value:n.value,timestamp:n.timestamp+t}),l=!e,e=!0),l)if(f!==null)r.onError(f);else c=new h,s.setDisposable(c),c.setDisposable(i.scheduleRecursiveFuture(null,t,function(n,t){var h,c,s,l;if(f===null){o=!0;do s=null,u.length>0&&u[0].timestamp-i.now()<=0&&(s=u.shift().value),s!==null&&s.accept(r);while(s!==null);if(l=!1,c=0,u.length>0?(l=!0,c=Math.max(0,u[0].timestamp-i.now())):e=!1,h=f,o=!1,h!==null)r.onError(h);else l&&t(null,c)}}))}),new k(c,s)},n)}function la(n,t,i){return af(function(){return us(n,t-i.now(),i)})}function aa(n,t,i){var r,f;return c(t)?f=t:(r=t,f=i),new d(function(t){function s(){e.setDisposable(n.subscribe(function(n){var e=o(f)(n),r;if(e===u)return t.onError(e.e);r=new h;i.add(r);r.setDisposable(e.subscribe(function(){t.onNext(n);i.remove(r);c()},function(n){t.onError(n)},function(){t.onNext(n);i.remove(r);c()}))},function(n){t.onError(n)},function(){l=!0;e.dispose();c()}))}function c(){l&&i.length===0&&t.onCompleted()}var i=new ct,l=!1,e=new w;return r?e.setDisposable(r.subscribe(s,function(n){t.onError(n)},s)):s(),new k(e,i)},this)}function va(n,t){return new d(function(i){var e,r=!1,s=new w,f=0,c=n.subscribe(function(n){var c=o(t)(n),a,l;if(c===u)return i.onError(c.e);p(c)&&(c=y(c));r=!0;e=n;f++;a=f;l=new h;s.setDisposable(l);l.setDisposable(c.subscribe(function(){r&&f===a&&i.onNext(e);r=!1;l.dispose()},function(n){i.onError(n)},function(){r&&f===a&&i.onNext(e);r=!1;l.dispose()}))},function(n){s.dispose();i.onError(n);r=!1;f++},function(){s.dispose();r&&i.onNext(e);i.onCompleted();r=!1;f++});return new k(c,s)},n)}function hs(n,t){return new d(function(i){function o(){if(r){r=!1;i.onNext(e)}f&&i.onCompleted()}var f=!1,e,r=!1,u=new h;return u.setDisposable(n.subscribe(function(n){r=!0;e=n},function(n){i.onError(n)},function(){f=!0;u.dispose()})),new k(u,t.subscribe(o,function(n){i.onError(n)},o))},n)}function ya(n,t,i,r){return c(t)&&(r=i,i=t,t=tl()),s.isObservable(r)||(r=ei(new yi)),new d(function(f){function b(n){function i(){return c=u===s}var u=s,t=new h;a.setDisposable(t);t.setDisposable(n.subscribe(function(){i()&&e.setDisposable(r.subscribe(f));t.dispose()},function(n){i()&&f.onError(n)},function(){i()&&e.setDisposable(r.subscribe(f))}))}function l(){var n=!c;return n&&s++,n}var e=new w,a=new w,v=new h,s,c;return e.setDisposable(v),s=0,c=!1,b(t),v.setDisposable(n.subscribe(function(n){if(l()){f.onNext(n);var t=o(i)(n);if(t===u)return f.onError(t.e);b(p(t)?y(t):t)}},function(n){l()&&f.onError(n)},function(){l()&&f.onCompleted()})),new k(e,a)},n)}function pa(n,t,i,r){return v(i)&&(r=i,i=ei(new yi)),i instanceof Error&&(i=ei(i)),v(r)||(r=st),s.isObservable(i)||(i=ei(new yi)),new d(function(u){function l(){var n=f;c.setDisposable(r.scheduleFuture(null,t,function(){e=f===n;e&&(p(i)&&(i=y(i)),o.setDisposable(i.subscribe(u)))}))}var f=0,s=new h,o=new w,e=!1,c=new w;return o.setDisposable(s),l(),s.setDisposable(n.subscribe(function(n){if(!e){f++;u.onNext(n);l()}},function(n){if(!e){f++;u.onError(n)}},function(){e||(f++,u.onCompleted())})),new k(o,c)},n)}function wa(n,t,i){return new d(function(r){function h(n,t){if(f[t]=n,c[t]=!0,l||(l=c.every(ht))){if(s)return r.onError(s);var h=o(i).apply(null,f);if(h===u)return r.onError(h.e);r.onNext(h)}e&&f[1]&&r.onCompleted()}var c=[!1,!1],l=!1,e=!1,f=new Array(2),s;return new k(n.subscribe(function(n){h(n,0)},function(n){if(f[1])r.onError(n);else s=n},function(){e=!0;f[1]&&r.onCompleted()}),t.subscribe(function(n){h(n,1)},function(n){r.onError(n)},function(){e=!0;h(!0,1)}))},n)}function ba(n){return{"@@transducer/init":function(){return n},"@@transducer/step":function(n,t){return n.onNext(t)},"@@transducer/result":function(n){return n.onCompleted()}}}var oi={"function":!0,object:!0},si=oi[typeof exports]&&exports&&!exports.nodeType?exports:null,hi=oi[typeof module]&&module&&!module.nodeType?module:null,or=pi(si&&hi&&typeof global=="object"&&global),ds=pi(oi[typeof self]&&self),uu=pi(oi[typeof window]&&window),fu=hi&&hi.exports===si?si:null,sr=pi(oi[typeof this]&&this),l=or||uu!==(sr&&sr.window)&&uu||ds||sr||Function("return this")(),r={internals:{},config:{Promise:l.Promise},helpers:{}},it=r.helpers.noop=function(){},ht=r.helpers.identity=function(n){return n},eu=r.helpers.defaultNow=Date.now,gs=r.helpers.defaultComparer=function(n,t){return yh(n,t)},nh=r.helpers.defaultSubComparer=function(n,t){return n>t?1:n<t?-1:0},da=r.helpers.defaultKeySerializer=function(n){return n.toString()},th=r.helpers.defaultError=function(n){throw n;},p=r.helpers.isPromise=function(n){return!!n&&typeof n.subscribe!="function"&&typeof n.then=="function"},c=r.helpers.isFunction=function(){var n=function(n){return typeof n=="function"||!1};return n(/x/)&&(n=function(n){return typeof n=="function"&&toString.call(n)=="[object Function]"}),n}(),u={e:{}},o=r.internals.tryCatch=function(n){if(!c(n))throw new TypeError("fn must be a function");return ih(n)},ci,hr,ou,su,cr,lr,wi,kt,dt,yt,nf,pr,wr,ct,nr,lt,w,k,et,wh,fi,of,st,li,at,hf,cf,kf,df,gf,te,ie,re,ue,ur,fe,ee,oe,se,he,ce,le,ve,ye,pe,we,be,ke,de,ge,no,to,io,ro,uo,fo,eo,oo,so,ho,iu,co,lo,ao,vo,yo,po,ru,ko,ns,rs,ca,fs,es,os,ss,yi,cs,ls,as,vs,ys,ks;r.config.longStackSupport=!1;ci=!1;hr=o(function(){throw new Error;})();ci=!!hr.e&&!!hr.e.stack;ou=hu();cr="From previous event:";lr=r.EmptyError=function(){this.message="Sequence contains no elements.";Error.call(this)};lr.prototype=Object.create(Error.prototype);lr.prototype.name="EmptyError";wi=r.ObjectDisposedError=function(){this.message="Object has been disposed";Error.call(this)};wi.prototype=Object.create(Error.prototype);wi.prototype.name="ObjectDisposedError";kt=r.ArgumentOutOfRangeError=function(){this.message="Argument out of range";Error.call(this)};kt.prototype=Object.create(Error.prototype);kt.prototype.name="ArgumentOutOfRangeError";dt=r.NotSupportedError=function(n){this.message=n||"This operation is not supported";Error.call(this)};dt.prototype=Object.create(Error.prototype);dt.prototype.name="NotSupportedError";yt=r.NotImplementedError=function(n){this.message=n||"This operation is not implemented";Error.call(this)};yt.prototype=Object.create(Error.prototype);yt.prototype.name="NotImplementedError";var bi=r.helpers.notImplemented=function(){throw new yt;},ga=r.helpers.notSupported=function(){throw new dt;},g=typeof Symbol=="function"&&Symbol.iterator||"_es6shim_iterator_";l.Set&&typeof(new l.Set)["@@iterator"]=="function"&&(g="@@iterator");var ki=r.doneEnumerator={done:!0,value:n},lu=r.helpers.isIterable=function(t){return t&&t[g]!==n},au=r.helpers.isArrayLike=function(t){return t&&t.length!==n};r.helpers.iterator=g;var pt=r.internals.bindCallback=function(n,t,i){if(typeof t=="undefined")return n;switch(i){case 0:return function(){return n.call(t)};case 1:return function(i){return n.call(t,i)};case 2:return function(i,r){return n.call(t,i,r)};case 3:return function(i,r,u){return n.call(t,i,r,u)}}return function(){return n.apply(t,arguments)}},nv=7,ar="[object Arguments]",di="[object Array]",vu="[object Boolean]",yu="[object Date]",pu="[object Error]",wu="[object Number]",ii="[object Object]",bu="[object RegExp]",ku="[object String]",a={};a["[object Float32Array]"]=a["[object Float64Array]"]=a["[object Int8Array]"]=a["[object Int16Array]"]=a["[object Int32Array]"]=a["[object Uint8Array]"]=a["[object Uint8ClampedArray]"]=a["[object Uint16Array]"]=a["[object Uint32Array]"]=!0;a[ar]=a[di]=a["[object ArrayBuffer]"]=a[vu]=a[yu]=a[pu]=a["[object Function]"]=a["[object Map]"]=a[wu]=a[ii]=a[bu]=a["[object Set]"]=a[ku]=a["[object WeakMap]"]=!1;var du=Object.prototype,vr=du.hasOwnProperty,gi=du.toString,oh=Math.pow(2,53)-1,gu=Object.keys||function(){var t=Object.prototype.hasOwnProperty,i=!{toString:null}.propertyIsEnumerable("toString"),n=["toString","toLocaleString","valueOf","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","constructor"],r=n.length;return function(u){if(typeof u!="object"&&(typeof u!="function"||u===null))throw new TypeError("Object.keys called on non-object");var e=[],o,f;for(o in u)t.call(u,o)&&e.push(o);if(i)for(f=0;f<r;f++)t.call(u,n[f])&&e.push(n[f]);return e}}();nf=r.internals.isObject=function(n){var t=typeof n;return!!n&&(t==="object"||t==="function")};pr=function(){try{Object({toString:0}+"")}catch(n){return function(){return!1}}return function(n){return typeof n.toString!="function"&&typeof(n+"")=="string"}}();wr=Array.isArray||function(n){return yr(n)&&tf(n.length)&&gi.call(n)===di};var yh=r.internals.isEqual=function(n,t){return rf(n,t)},tv={}.hasOwnProperty,iv=Array.prototype.slice,t=r.internals.inherits=function(n,t){function i(){this.constructor=n}i.prototype=t.prototype;n.prototype=new i},ri=r.internals.addProperties=function(n){for(var t,e,u,f,i=[],r=1,o=arguments.length;r<o;r++)i.push(arguments[r]);for(t=0,e=i.length;t<e;t++){u=i[t];for(f in u)n[f]=u[f]}},rv=r.internals.addRef=function(n,t){return new d(function(i){return new k(t.getDisposable(),n.subscribe(i))})};ct=r.CompositeDisposable=function(){var n=[],t,i;if(Array.isArray(arguments[0]))n=arguments[0];else for(i=arguments.length,n=new Array(i),t=0;t<i;t++)n[t]=arguments[t];this.disposables=n;this.isDisposed=!1;this.length=n.length};nr=ct.prototype;nr.add=function(n){this.isDisposed?n.dispose():(this.disposables.push(n),this.length++)};nr.remove=function(n){var i=!1,t;return this.isDisposed||(t=this.disposables.indexOf(n),t!==-1&&(i=!0,this.disposables.splice(t,1),this.length--,n.dispose())),i};nr.dispose=function(){var t,i,n;if(!this.isDisposed){for(this.isDisposed=!0,t=this.disposables.length,i=new Array(t),n=0;n<t;n++)i[n]=this.disposables[n];for(this.disposables=[],this.length=0,n=0;n<t;n++)i[n].dispose()}};lt=r.Disposable=function(n){this.isDisposed=!1;this.action=n||it};lt.prototype.dispose=function(){this.isDisposed||(this.action(),this.isDisposed=!0)};var ui=lt.create=function(n){return new lt(n)},nt=lt.empty={dispose:it},ph=lt.isDisposable=function(n){return n&&c(n.dispose)},b=lt.checkDisposed=function(n){if(n.isDisposed)throw new wi;},uf=lt._fixup=function(n){return ph(n)?n:nt},h=r.SingleAssignmentDisposable=function(){this.isDisposed=!1;this.current=null};h.prototype.getDisposable=function(){return this.current};h.prototype.setDisposable=function(n){if(this.current)throw new Error("Disposable has already been assigned");var t=this.isDisposed;t||(this.current=n);t&&n&&n.dispose()};h.prototype.dispose=function(){if(!this.isDisposed){this.isDisposed=!0;var n=this.current;this.current=null;n&&n.dispose()}};w=r.SerialDisposable=function(){this.isDisposed=!1;this.current=null};w.prototype.getDisposable=function(){return this.current};w.prototype.setDisposable=function(n){var i=this.isDisposed,t;i||(t=this.current,this.current=n);t&&t.dispose();i&&n&&n.dispose()};w.prototype.dispose=function(){if(!this.isDisposed){this.isDisposed=!0;var n=this.current;this.current=null}n&&n.dispose()};k=r.BinaryDisposable=function(n,t){this._first=n;this._second=t;this.isDisposed=!1};k.prototype.dispose=function(){var n,t;this.isDisposed||(this.isDisposed=!0,n=this._first,this._first=null,n&&n.dispose(),t=this._second,this._second=null,t&&t.dispose())};et=r.NAryDisposable=function(n){this._disposables=n;this.isDisposed=!1};et.prototype.dispose=function(){if(!this.isDisposed){this.isDisposed=!0;for(var n=0,t=this._disposables.length;n<t;n++)this._disposables[n].dispose();this._disposables.length=0}};wh=r.RefCountDisposable=function(){function t(n){this.disposable=n;this.disposable.count++;this.isInnerDisposed=!1}function n(n){this.underlyingDisposable=n;this.isDisposed=!1;this.isPrimaryDisposed=!1;this.count=0}return t.prototype.dispose=function(){this.disposable.isDisposed||this.isInnerDisposed||(this.isInnerDisposed=!0,this.disposable.count--,this.disposable.count===0&&this.disposable.isPrimaryDisposed&&(this.disposable.isDisposed=!0,this.disposable.underlyingDisposable.dispose()))},n.prototype.dispose=function(){this.isDisposed||this.isPrimaryDisposed||(this.isPrimaryDisposed=!0,this.count===0&&(this.isDisposed=!0,this.underlyingDisposable.dispose()))},n.prototype.getDisposable=function(){return this.isDisposed?nt:new t(this)},n}();fi=r.internals.ScheduledItem=function(n,t,i,r,u){this.scheduler=n;this.state=t;this.action=i;this.dueTime=r;this.comparer=u||nh;this.disposable=new h};fi.prototype.invoke=function(){this.disposable.setDisposable(this.invokeCore())};fi.prototype.compareTo=function(n){return this.comparer(this.dueTime,n.dueTime)};fi.prototype.isCancelled=function(){return this.disposable.isDisposed};fi.prototype.invokeCore=function(){return uf(this.action(this.scheduler,this.state))};var ot=r.Scheduler=function(){function n(){}n.isScheduler=function(t){return t instanceof n};var t=n.prototype;return t.schedule=function(){throw new yt;},t.scheduleFuture=function(t,i,r){var u=i;return(u instanceof Date&&(u=u-this.now()),u=n.normalize(u),u===0)?this.schedule(t,r):this._scheduleFuture(t,u,r)},t._scheduleFuture=function(){throw new yt;},n.now=eu,n.prototype.now=eu,n.normalize=function(n){return n<0&&(n=0),n},n}(),ff=ot.normalize,v=ot.isScheduler;(function(n){function t(n,t){function u(t){function s(n,t){return f?i.remove(o):e=!0,r(t,u),nt}var f=!1,e=!1,o=n.schedule(t,s);e||(i.add(o),f=!0)}var f=t[0],r=t[1],i=new ct;return r(f,u),i}function i(n,t){function u(t,f){function h(n,t){return e?i.remove(s):o=!0,r(t,u),nt}var e=!1,o=!1,s=n.scheduleFuture(t,f,h);o||(i.add(s),e=!0)}var f=t[0],r=t[1],i=new ct;return r(f,u),i}n.scheduleRecursive=function(n,i){return this.schedule([n,i],t)};n.scheduleRecursiveFuture=function(n,t,r){return this.scheduleFuture([n,r],t,i)}})(ot.prototype),function(n){n.schedulePeriodic=function(n,t,i){if(typeof l.setInterval=="undefined")throw new dt;t=ff(t);var r=n,u=l.setInterval(function(){r=i(r)},t);return ui(function(){l.clearInterval(u)})}}(ot.prototype);var bh=function(n){function i(){n.call(this)}return t(i,n),i.prototype.schedule=function(n,t){return uf(t(this,n))},i}(ot),ut=ot.immediate=new bh,kh=function(n){function f(){while(i.length>0){var n=i.dequeue();n.isCancelled()||n.invoke()}}function r(){n.call(this)}var i;return t(r,n),r.prototype.schedule=function(n,t){var r=new fi(this,n,t,this.now()),e;return i?i.enqueue(r):(i=new li(4),i.enqueue(r),e=o(f)(),i=null,e===u&&rt(e.e)),r.disposable},r.prototype.scheduleRequired=function(){return!i},r}(ot),tt=ot.currentThread=new kh,uv=r.internals.SchedulePeriodicRecursive=function(){function t(n){return function(t,i){i(0,n._period);var r=o(n._action)(n._state);r===u&&(n._cancel.dispose(),rt(r.e));n._state=r}}function n(n,t,i,r){this._scheduler=n;this._state=t;this._period=i;this._action=r}return n.prototype.start=function(){var n=new h;return this._cancel=n,n.setDisposable(this._scheduler.scheduleRecursiveFuture(0,this._period,t(this))),n},n}(),ni,br,ef=function(){var n,t=it;if(!l.setTimeout)if(!l.WScript)throw new dt;else n=function(n,t){l.WScript.Sleep(t);n()};else n=l.setTimeout,t=l.clearTimeout;return{setTimeout:n,clearTimeout:t}}(),kr=ef.setTimeout,dh=ef.clearTimeout;(function(){function t(i){var r,f;e?kr(function(){t(i)},0):(r=n[i],r&&(e=!0,f=o(r)(),br(i),e=!1,f===u&&rt(f.e)))}function v(){if(!l.postMessage||l.importScripts)return!1;var n=!1,t=l.onmessage;return l.onmessage=function(){n=!0},l.postMessage("","*"),l.onmessage=t,n}var i=1,n={},e=!1,h,r,f,a,s;br=function(t){delete n[t]};h=new RegExp("^"+String(toString).replace(/[.*+?^${}()|[\]\\]/g,"\\$&").replace(/toString| for [^\]]+/g,".*?")+"$");r=typeof(r=or&&fu&&or.setImmediate)=="function"&&!h.test(r)&&r;c(r)?ni=function(u){var f=i++;return n[f]=u,r(function(){t(f)}),f}:typeof process!="undefined"&&{}.toString.call(process)==="[object process]"?ni=function(r){var u=i++;return n[u]=r,process.nextTick(function(){t(u)}),u}:v()?(f="ms.rx.schedule"+Math.random(),a=function(n){typeof n.data=="string"&&n.data.substring(0,f.length)===f&&t(n.data.substring(f.length))},l.addEventListener("message",a,!1),ni=function(t){var r=i++;return n[r]=t,l.postMessage(f+currentId,"*"),r}):l.MessageChannel?(s=new l.MessageChannel,s.port1.onmessage=function(n){t(n.data)},ni=function(t){var r=i++;return n[r]=t,s.port2.postMessage(r),r}):ni="document"in l&&"onreadystatechange"in l.document.createElement("script")?function(r){var u=l.document.createElement("script"),f=i++;return n[f]=r,u.onreadystatechange=function(){t(f);u.onreadystatechange=null;u.parentNode.removeChild(u);u=null},l.document.documentElement.appendChild(u),f}:function(r){var u=i++;return n[u]=r,kr(function(){t(u)},0),u}})();of=function(n){function i(){n.call(this)}function r(n,t,i,r){return function(){n.setDisposable(lt._fixup(t(i,r)))}}function u(n){this._id=n;this.isDisposed=!1}function f(n){this._id=n;this.isDisposed=!1}return t(i,n),u.prototype.dispose=function(){this.isDisposed||(this.isDisposed=!0,br(this._id))},f.prototype.dispose=function(){this.isDisposed||(this.isDisposed=!0,dh(this._id))},i.prototype.schedule=function(n,t){var i=new h,f=ni(r(i,t,this,n));return new k(i,new u(f))},i.prototype._scheduleFuture=function(n,t,i){if(t===0)return this.schedule(n,i);var u=new h,e=kr(r(u,i,this,n),t);return new k(u,new f(e))},i}(ot);st=ot["default"]=ot.async=new of;sf.prototype.compareTo=function(n){var t=this.value.compareTo(n.value);return t===0&&(t=this.id-n.id),t};li=r.internals.PriorityQueue=function(n){this.items=new Array(n);this.length=0};at=li.prototype;at.isHigherPriority=function(n,t){return this.items[n].compareTo(this.items[t])<0};at.percolate=function(n){var t,i;n>=this.length||n<0||(t=n-1>>1,t<0||t===n)||this.isHigherPriority(n,t)&&(i=this.items[n],this.items[n]=this.items[t],this.items[t]=i,this.percolate(t))};at.heapify=function(n){var u;if(+n||(n=0),!(n>=this.length)&&!(n<0)){var i=2*n+1,r=2*n+2,t=n;i<this.length&&this.isHigherPriority(i,t)&&(t=i);r<this.length&&this.isHigherPriority(r,t)&&(t=r);t!==n&&(u=this.items[n],this.items[n]=this.items[t],this.items[t]=u,this.heapify(t))}};at.peek=function(){return this.items[0].value};at.removeAt=function(t){this.items[t]=this.items[--this.length];this.items[this.length]=n;this.heapify()};at.dequeue=function(){var n=this.peek();return this.removeAt(0),n};at.enqueue=function(n){var t=this.length++;this.items[t]=new sf(li.count++,n);this.percolate(t)};at.remove=function(n){for(var t=0;t<this.length;t++)if(this.items[t].value===n)return this.removeAt(t),!0;return!1};li.count=0;var vt=r.Notification=function(){function n(){}return n.prototype._accept=function(){throw new yt;},n.prototype._acceptObserver=function(){throw new yt;},n.prototype.accept=function(n,t,i){return n&&typeof n=="object"?this._acceptObserver(n):this._accept(n,t,i)},n.prototype.toObservable=function(n){var t=this;return v(n)||(n=ut),new d(function(i){return n.schedule(t,function(n,t){t._acceptObserver(i);t.kind==="N"&&i.onCompleted()})})},n}(),gh=function(n){function i(n){this.value=n;this.kind="N"}return t(i,n),i.prototype._accept=function(n){return n(this.value)},i.prototype._acceptObserver=function(n){return n.onNext(this.value)},i.prototype.toString=function(){return"OnNext("+this.value+")"},i}(vt),nc=function(n){function i(n){this.error=n;this.kind="E"}return t(i,n),i.prototype._accept=function(n,t){return t(this.error)},i.prototype._acceptObserver=function(n){return n.onError(this.error)},i.prototype.toString=function(){return"OnError("+this.error+")"},i}(vt),tc=function(n){function i(){this.kind="C"}return t(i,n),i.prototype._accept=function(n,t,i){return i()},i.prototype._acceptObserver=function(n){return n.onCompleted()},i.prototype.toString=function(){return"OnCompleted()"},i}(vt),ic=vt.createOnNext=function(n){return new gh(n)},rc=vt.createOnError=function(n){return new nc(n)},uc=vt.createOnCompleted=function(){return new tc},wt=r.Observer=function(){},ai=wt.create=function(n,t,i){return n||(n=it),t||(t=th),i||(i=it),new fc(n,t,i)},f=r.internals.AbstractObserver=function(n){function i(){this.isStopped=!1}return t(i,n),i.prototype.next=bi,i.prototype.error=bi,i.prototype.completed=bi,i.prototype.onNext=function(n){this.isStopped||this.next(n)},i.prototype.onError=function(n){this.isStopped||(this.isStopped=!0,this.error(n))},i.prototype.onCompleted=function(){this.isStopped||(this.isStopped=!0,this.completed())},i.prototype.dispose=function(){this.isStopped=!0},i.prototype.fail=function(n){return this.isStopped?!1:(this.isStopped=!0,this.error(n),!0)},i}(wt),fc=r.AnonymousObserver=function(n){function i(t,i,r){n.call(this);this._onNext=t;this._onError=i;this._onCompleted=r}return t(i,n),i.prototype.next=function(n){this._onNext(n)},i.prototype.error=function(n){this._onError(n)},i.prototype.completed=function(){this._onCompleted()},i}(f),i,s=r.Observable=function(){function t(n,t){return function(i){var r=i.onError;return i.onError=function(t){rh(t,n);r.call(i,t)},t.call(n,i)}}function n(){if(r.config.longStackSupport&&ci){var i=this._subscribe,n=o(rt)(new Error).e;this.stack=n.stack.substring(n.stack.indexOf("\n")+1);this._subscribe=t(this,i)}}return i=n.prototype,n.isObservable=function(n){return n&&c(n.subscribe)},i.subscribe=i.forEach=function(n,t,i){return this._subscribe(typeof n=="object"?n:ai(n,t,i))},i.subscribeOnNext=function(n,t){return this._subscribe(ai(typeof t!="undefined"?function(i){n.call(t,i)}:n))},i.subscribeOnError=function(n,t){return this._subscribe(ai(null,typeof t!="undefined"?function(i){n.call(t,i)}:n))},i.subscribeOnCompleted=function(n,t){return this._subscribe(ai(null,null,typeof t!="undefined"?function(){n.call(t)}:n))},n}(),ec=r.internals.ScheduledObserver=function(n){function i(t,i){n.call(this);this.scheduler=t;this.observer=i;this.isAcquired=!1;this.hasFaulted=!1;this.queue=[];this.disposable=new w}function r(n,t){return function(){n.onNext(t)}}function f(n,t){return function(){n.onError(t)}}function e(n){return function(){n.onCompleted()}}function s(n,t){var r,i;if(n.queue.length>0)r=n.queue.shift();else{n.isAcquired=!1;return}if(i=o(r)(),i===u)return n.queue=[],n.hasFaulted=!0,rt(i.e);t(n)}return t(i,n),i.prototype.next=function(n){this.queue.push(r(this.observer,n))},i.prototype.error=function(n){this.queue.push(f(this.observer,n))},i.prototype.completed=function(){this.queue.push(e(this.observer))},i.prototype.ensureActive=function(){var n=!1;!this.hasFaulted&&this.queue.length>0&&(n=!this.isAcquired,this.isAcquired=!0);n&&this.disposable.setDisposable(this.scheduler.scheduleRecursive(this,s))},i.prototype.dispose=function(){n.prototype.dispose.call(this);this.disposable.dispose()},i}(f),e=r.ObservableBase=function(n){function f(n){return n&&c(n.dispose)?n:c(n)?ui(n):nt}function r(n,t){var i=t[0],r=t[1],e=o(r.subscribeCore).call(r,i);e!==u||i.fail(u.e)||rt(u.e);i.setDisposable(f(e))}function i(){n.call(this)}return t(i,n),i.prototype._subscribe=function(n){var t=new ps(n),i=[t,this];return tt.scheduleRequired()?tt.schedule(i,r):r(null,i),t},i.prototype.subscribeCore=bi,i}(s),dr=r.FlatMapObservable=function(n){function r(t,i,r,u){this.resultSelector=c(r)?r:null;this.selector=pt(c(i)?i:function(){return i},u,3);this.source=t;n.call(this)}function i(n,t,i,r){this.i=0;this.selector=t;this.resultSelector=i;this.source=r;this.o=n;f.call(this)}return t(r,n),r.prototype.subscribeCore=function(n){return this.source.subscribe(new i(n,this.selector,this.resultSelector,this))},t(i,f),i.prototype._wrapResult=function(n,t,i){return this.resultSelector?n.map(function(n,r){return this.resultSelector(t,n,i,r)},this):n},i.prototype.next=function(n){var i=this.i++,t=o(this.selector)(n,i,this.source);if(t===u)return this.o.onError(t.e);p(t)&&(t=y(t));(au(t)||lu(t))&&(t=s.from(t));this.o.onNext(this._wrapResult(t,n,i))},i.prototype.error=function(n){this.o.onError(n)},i.prototype.completed=function(){this.o.onCompleted()},r}(e),ti=r.internals.Enumerable=function(){};tr.prototype.dispose=function(){this.isDisposed||(this.isDisposed=!0,this._s.isDisposed=!0)};hf=function(n){function r(t){this.sources=t;n.call(this)}function e(n,t){var r,f,e;if(!n.isDisposed){if(r=o(n.e.next).call(n.e),r===u)return n.o.onError(r.e);if(r.done)return n.o.onCompleted();f=r.value;p(f)&&(f=y(f));e=new h;n.subscription.setDisposable(e);e.setDisposable(f.subscribe(new i(n,t)))}}function i(n,t){this._state=n;this._recurse=t;f.call(this)}return t(r,n),r.prototype.subscribeCore=function(n){var t=new w,i={isDisposed:!1,o:n,subscription:t,e:this.sources[g]()},r=tt.scheduleRecursive(i,e);return new et([t,r,new tr(i)])},t(i,f),i.prototype.next=function(n){this._state.o.onNext(n)},i.prototype.error=function(n){this._state.o.onError(n)},i.prototype.completed=function(){this._recurse(this._state)},r}(e);ti.prototype.concat=function(){return new hf(this)};cf=function(n){function r(t){this.sources=t;n.call(this)}function e(n,t){var r,f,e;if(!n.isDisposed){if(r=o(n.e.next).call(n.e),r===u)return n.o.onError(r.e);if(r.done)return n.lastError!==null?n.o.onError(n.lastError):n.o.onCompleted();f=r.value;p(f)&&(f=y(f));e=new h;n.subscription.setDisposable(e);e.setDisposable(f.subscribe(new i(n,t)))}}function i(n,t){this._state=n;this._recurse=t;f.call(this)}return t(r,n),r.prototype.subscribeCore=function(n){var t=new w,i={isDisposed:!1,e:this.sources[g](),subscription:t,lastError:null,o:n},r=tt.scheduleRecursive(i,e);return new et([t,r,new tr(i)])},t(i,f),i.prototype.next=function(n){this._state.o.onNext(n)},i.prototype.error=function(n){this._state.lastError=n;this._recurse(this._state)},i.prototype.completed=function(){this._state.o.onCompleted()},r}(e);ti.prototype.catchError=function(){return new cf(this)};ti.prototype.catchErrorWhen=function(n){var t=this;return new d(function(i){var r=new bt,f=new bt,a=n(r),v=a.subscribe(f),e=t[g](),s={isDisposed:!1},c,l=new w,b=tt.scheduleRecursive(null,function(n,t){var a,v,w,b;if(!s.isDisposed){if(a=o(e.next).call(e),a===u)return i.onError(a.e);if(a.done){if(c)i.onError(c);else i.onCompleted();return}v=a.value;p(v)&&(v=y(v));w=new h;b=new h;l.setDisposable(new k(b,w));w.setDisposable(v.subscribe(function(n){i.onNext(n)},function(n){b.setDisposable(f.subscribe(t,function(n){i.onError(n)},function(){i.onCompleted()}));r.onNext(n)},function(){i.onCompleted()}))}});return new et([v,l,b,new tr(s)])})};var oc=function(n){function i(n,t){this.v=n;this.c=t==null?-1:t}function r(n){this.v=n.v;this.l=n.c}return t(i,n),i.prototype[g]=function(){return new r(this)},r.prototype.next=function(){return this.l===0?ki:(this.l>0&&this.l--,{done:!1,value:this.v})},i}(ti),gr=ti.repeat=function(n,t){return new oc(n,t)},sc=function(n){function i(n,t,i){this.s=n;this.fn=t?pt(t,i,3):null}function r(n){this.i=-1;this.s=n.s;this.l=this.s.length;this.fn=n.fn}return t(i,n),i.prototype[g]=function(){return new r(this)},r.prototype.next=function(){return++this.i<this.l?{done:!1,value:this.fn?this.fn(this.s[this.i],this.i,this.s):this.s[this.i]}:ki},i}(ti),lf=ti.of=function(n,t,i){return new sc(n,t,i)},hc=function(n){function r(t){this.source=t;n.call(this)}function i(n){this.o=n;this.a=[];f.call(this)}return t(r,n),r.prototype.subscribeCore=function(n){return this.source.subscribe(new i(n))},t(i,f),i.prototype.next=function(n){this.a.push(n)},i.prototype.error=function(n){this.o.onError(n)},i.prototype.completed=function(){this.o.onNext(this.a);this.o.onCompleted()},r}(e);i.toArray=function(){return new hc(this)};s.create=function(n,t){return new d(n,t)};var cc=function(n){function i(t){this._f=t;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){var t=o(this._f)();return t===u?ei(t.e).subscribe(n):(p(t)&&(t=y(t)),t.subscribe(n))},i}(e),af=s.defer=function(n){return new cc(n)},vf=function(n){function i(t){this.scheduler=t;n.call(this)}function r(n,t){this.observer=n;this.scheduler=t}function u(n,t){return t.onCompleted(),nt}return t(i,n),i.prototype.subscribeCore=function(n){var t=new r(n,this.scheduler);return t.run()},r.prototype.run=function(){var n=this.observer;return this.scheduler===ut?u(null,n):this.scheduler.schedule(n,u)},i}(e),lc=new vf(ut),ac=s.empty=function(n){return v(n)||(n=ut),n===ut?lc:new vf(n)},vc=function(n){function i(t,i,r){this._iterable=t;this._fn=i;this._scheduler=r;n.call(this)}function r(n,t,i){return function(r,f){var s=o(t.next).call(t),e;if(s===u)return n.onError(s.e);if(s.done)return n.onCompleted();if(e=s.value,c(i)&&(e=o(i)(e,r),e===u))return n.onError(e.e);n.onNext(e);f(r+1)}}return t(i,n),i.prototype.subscribeCore=function(n){var t=Object(this._iterable),i=pc(t);return this._scheduler.scheduleRecursive(0,r(n,i,this._fn))},i}(e),yf=Math.pow(2,53)-1;pf.prototype[g]=function(){return new nu(this._s)};nu.prototype[g]=function(){return this};nu.prototype.next=function(){return this._i<this._l?{done:!1,value:this._s.charAt(this._i++)}:ki};wf.prototype[g]=function(){return new tu(this._a)};tu.prototype[g]=function(){return this};tu.prototype.next=function(){return this._i<this._l?{done:!1,value:this._a[this._i++]}:ki};var kc=s.from=function(n,t,i,r){if(n==null)throw new Error("iterable cannot be null.");if(t&&!c(t))throw new Error("mapFn when provided must be a function");if(t)var u=pt(t,i,2);return v(r)||(r=tt),new vc(n,u,r)},ir=function(n){function i(t,i){this._args=t;this._scheduler=i;n.call(this)}function r(n,t){var i=t.length;return function(r,u){if(r<i){n.onNext(t[r]);u(r+1)}else n.onCompleted()}}return t(i,n),i.prototype.subscribeCore=function(n){return this._scheduler.scheduleRecursive(0,r(n,this._args))},i}(e),dc=s.fromArray=function(n,t){return v(t)||(t=tt),new ir(n,t)},gc=function(n){function i(){n.call(this)}return t(i,n),i.prototype.subscribeCore=function(){return nt},i}(e),nl=new gc,tl=s.never=function(){return nl};s.of=function(){for(var t=arguments.length,i=new Array(t),n=0;n<t;n++)i[n]=arguments[n];return new ir(i,tt)};s.ofWithScheduler=function(n){for(var i=arguments.length,r=new Array(i-1),t=1;t<i;t++)r[t-1]=arguments[t];return new ir(r,n)};kf=function(n){function i(t,i){this._o=t;this._keys=Object.keys(t);this._scheduler=i;n.call(this)}function r(n,t,i){return function(r,u){if(r<i.length){var f=i[r];n.onNext([f,t[f]]);u(r+1)}else n.onCompleted()}}return t(i,n),i.prototype.subscribeCore=function(n){return this._scheduler.scheduleRecursive(0,r(n,this._o,this._keys))},i}(e);s.pairs=function(n,t){return t||(t=tt),new kf(n,t)};df=function(n){function i(t,i,r){this.start=t;this.rangeCount=i;this.scheduler=r;n.call(this)}function r(n,t,i){return function(r,u){if(r<t){i.onNext(n+r);u(r+1)}else i.onCompleted()}}return t(i,n),i.prototype.subscribeCore=function(n){return this.scheduler.scheduleRecursive(0,r(this.start,this.rangeCount,n))},i}(e);s.range=function(n,t,i){return v(i)||(i=tt),new df(n,t,i)};gf=function(n){function i(t,i,r){this.value=t;this.repeatCount=i==null?-1:i;this.scheduler=r;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){var t=new ne(n,this);return t.run()},i}(e);ne.prototype.run=function(){function i(i,r){if(i===-1||i>0){n.onNext(t);i>0&&i--}if(i===0)return n.onCompleted();r(i)}var n=this.observer,t=this.parent.value;return this.parent.scheduler.scheduleRecursive(this.parent.repeatCount,i)};s.repeat=function(n,t,i){return v(i)||(i=tt),new gf(n,t,i)};var il=function(n){function i(t,i){this._value=t;this._scheduler=i;n.call(this)}function r(n,t){var r=t[0],i=t[1];i.onNext(r);return i.onCompleted(),nt}return t(i,n),i.prototype.subscribeCore=function(n){var t=[this._value,n];return this._scheduler===ut?r(null,t):this._scheduler.schedule(t,r)},i}(e),ev=s["return"]=s.just=function(n,t){return v(t)||(t=ut),new il(n,t)},rl=function(n){function i(t,i){this._error=t;this._scheduler=i;n.call(this)}function r(n,t){var i=t[0],r=t[1];r.onError(i);return nt}return t(i,n),i.prototype.subscribeCore=function(n){var t=[this._error,n];return this._scheduler===ut?r(null,t):this._scheduler.schedule(t,r)},i}(e),ei=s["throw"]=function(n,t){return v(t)||(t=ut),new rl(n,t)},ul=function(n){function i(t,i){this.source=t;this._fn=i;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){var i=new h,t=new w;return t.setDisposable(i),i.setDisposable(this.source.subscribe(new fl(n,t,this._fn))),t},i}(e),fl=function(n){function i(t,i,r){this._o=t;this._s=i;this._fn=r;n.call(this)}return t(i,n),i.prototype.next=function(n){this._o.onNext(n)},i.prototype.completed=function(){return this._o.onCompleted()},i.prototype.error=function(n){var t=o(this._fn)(n),i;if(t===u)return this._o.onError(t.e);p(t)&&(t=y(t));i=new h;this._s.setDisposable(i);i.setDisposable(t.subscribe(this._o))},i}(f);i["catch"]=function(n){return c(n)?new ul(this,n):te([this,n])};te=s["catch"]=function(){var t,i,n;if(Array.isArray(arguments[0]))t=arguments[0];else for(i=arguments.length,t=new Array(i),n=0;n<i;n++)t[n]=arguments[n];return lf(t).catchError()};i.combineLatest=function(){for(var i=arguments.length,n=new Array(i),t=0;t<i;t++)n[t]=arguments[t];return Array.isArray(n[0])?n[0].unshift(this):n.unshift(this),sl.apply(this,n)};var el=function(n){function i(t,i){this._params=t;this._cb=i;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){for(var r,u,t=this._params.length,f=new Array(t),e={hasValue:gt(t,vi),hasValueAll:!1,isDone:gt(t,vi),values:new Array(t)},i=0;i<t;i++)r=this._params[i],u=new h,f[i]=u,p(r)&&(r=y(r)),u.setDisposable(r.subscribe(new ol(n,i,this._cb,e)));return new et(f)},i}(e),ol=function(n){function i(t,i,r,u){this._o=t;this._i=i;this._cb=r;this._state=u;n.call(this)}function r(n){return function(t,i){return i!==n}}return t(i,n),i.prototype.next=function(n){if(this._state.values[this._i]=n,this._state.hasValue[this._i]=!0,this._state.hasValueAll||(this._state.hasValueAll=this._state.hasValue.every(ht))){var t=o(this._cb).apply(null,this._state.values);if(t===u)return this._o.onError(t.e);this._o.onNext(t)}else this._state.isDone.filter(r(this._i)).every(ht)&&this._o.onCompleted()},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._state.isDone[this._i]=!0;this._state.isDone.every(ht)&&this._o.onCompleted()},i}(f),sl=s.combineLatest=function(){for(var r,i=arguments.length,n=new Array(i),t=0;t<i;t++)n[t]=arguments[t];return r=c(n[i-1])?n.pop():rr,Array.isArray(n[0])&&(n=n[0]),new el(n,r)};i.concat=function(){for(var n=[],t=0,i=arguments.length;t<i;t++)n.push(arguments[t]);return n.unshift(this),ll.apply(null,n)};var hl=function(n){function i(t,i){this._s=t;this._fn=i;n.call(this)}return t(i,n),i.prototype.next=function(n){this._s.o.onNext(n)},i.prototype.error=function(n){this._s.o.onError(n)},i.prototype.completed=function(){this._s.i++;this._fn(this._s)},i}(f),cl=function(n){function i(t){this._sources=t;n.call(this)}function r(n,t){var i,r;if(!n.disposable.isDisposed){if(n.i===n.sources.length)return n.o.onCompleted();i=n.sources[n.i];p(i)&&(i=y(i));r=new h;n.subscription.setDisposable(r);r.setDisposable(i.subscribe(new hl(n,t)))}}return t(i,n),i.prototype.subscribeCore=function(n){var t=new w,i=ui(it),u={o:n,i:0,subscription:t,disposable:i,sources:this._sources},f=ut.scheduleRecursive(u,r);return new et([t,i,f])},i}(e),ll=s.concat=function(){var t,n,i;if(Array.isArray(arguments[0]))t=arguments[0];else for(t=new Array(arguments.length),n=0,i=arguments.length;n<i;n++)t[n]=arguments[n];return new cl(t)};i.concatAll=function(){return this.merge(1)};ie=function(n){function i(t,i){this.source=t;this.maxConcurrent=i;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){var t=new ct;return t.add(this.source.subscribe(new re(n,this.maxConcurrent,t))),t},i}(e);re=function(n){function i(t,i,r){this.o=t;this.max=i;this.g=r;this.done=!1;this.q=[];this.activeCount=0;n.call(this)}function r(t,i){this.parent=t;this.sad=i;n.call(this)}return t(i,n),i.prototype.handleSubscribe=function(n){var t=new h;this.g.add(t);p(n)&&(n=y(n));t.setDisposable(n.subscribe(new r(this,t)))},i.prototype.next=function(n){this.activeCount<this.max?(this.activeCount++,this.handleSubscribe(n)):this.q.push(n)},i.prototype.error=function(n){this.o.onError(n)},i.prototype.completed=function(){this.done=!0;this.activeCount===0&&this.o.onCompleted()},t(r,n),r.prototype.next=function(n){this.parent.o.onNext(n)},r.prototype.error=function(n){this.parent.o.onError(n)},r.prototype.completed=function(){this.parent.g.remove(this.sad);this.parent.q.length>0?this.parent.handleSubscribe(this.parent.q.shift()):(this.parent.activeCount--,this.parent.done&&this.parent.activeCount===0&&this.parent.o.onCompleted())},i}(f);i.merge=function(n){return typeof n!="number"?ue(this,n):new ie(this,n)};ue=s.merge=function(){var i,t=[],n,r=arguments.length;if(arguments[0])if(v(arguments[0]))for(i=arguments[0],n=1;n<r;n++)t.push(arguments[n]);else for(i=ut,n=0;n<r;n++)t.push(arguments[n]);else for(i=ut,n=1;n<r;n++)t.push(arguments[n]);return Array.isArray(t[0])&&(t=t[0]),bf(i,t).mergeAll()};ur=r.CompositeError=function(n){this.innerErrors=n;this.message="This contains multiple errors. Check the innerErrors";Error.call(this)};ur.prototype=Object.create(Error.prototype);ur.prototype.name="CompositeError";fe=function(n){function i(t){this.source=t;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){var t=new ct,i=new h,r={isStopped:!1,errors:[],o:n};return t.add(i),i.setDisposable(this.source.subscribe(new ee(t,r))),t},i}(e);ee=function(n){function i(t,i){this._group=t;this._state=i;n.call(this)}function u(n,t){if(t.length===0)n.onCompleted();else if(t.length===1)n.onError(t[0]);else n.onError(new ur(t))}function r(t,i,r){this._inner=t;this._group=i;this._state=r;n.call(this)}return t(i,n),i.prototype.next=function(n){var t=new h;this._group.add(t);p(n)&&(n=y(n));t.setDisposable(n.subscribe(new r(t,this._group,this._state)))},i.prototype.error=function(n){this._state.errors.push(n);this._state.isStopped=!0;this._group.length===1&&u(this._state.o,this._state.errors)},i.prototype.completed=function(){this._state.isStopped=!0;this._group.length===1&&u(this._state.o,this._state.errors)},t(r,n),r.prototype.next=function(n){this._state.o.onNext(n)},r.prototype.error=function(n){this._state.errors.push(n);this._group.remove(this._inner);this._state.isStopped&&this._group.length===1&&u(this._state.o,this._state.errors)},r.prototype.completed=function(){this._group.remove(this._inner);this._state.isStopped&&this._group.length===1&&u(this._state.o,this._state.errors)},i}(f);s.mergeDelayError=function(){var t,i,n,r;if(Array.isArray(arguments[0]))t=arguments[0];else for(i=arguments.length,t=new Array(i),n=0;n<i;n++)t[n]=arguments[n];return r=bf(null,t),new fe(r)};oe=function(n){function i(t){this.source=t;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){var t=new ct,i=new h;return t.add(i),i.setDisposable(this.source.subscribe(new se(n,t))),t},i}(e);se=function(n){function i(t,i){this.o=t;this.g=i;this.done=!1;n.call(this)}function r(t,i){this.parent=t;this.sad=i;n.call(this)}return t(i,n),i.prototype.next=function(n){var t=new h;this.g.add(t);p(n)&&(n=y(n));t.setDisposable(n.subscribe(new r(this,t)))},i.prototype.error=function(n){this.o.onError(n)},i.prototype.completed=function(){this.done=!0;this.g.length===1&&this.o.onCompleted()},t(r,n),r.prototype.next=function(n){this.parent.o.onNext(n)},r.prototype.error=function(n){this.parent.o.onError(n)},r.prototype.completed=function(){this.parent.g.remove(this.sad);this.parent.done&&this.parent.g.length===1&&this.parent.o.onCompleted()},i}(f);i.mergeAll=function(){return new oe(this)};var al=function(n){function i(t,i){this._s=t;this._o=p(i)?y(i):i;this._open=!1;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){var i=new h,t;return i.setDisposable(this._s.subscribe(new vl(n,this))),p(this._o)&&(this._o=y(this._o)),t=new h,t.setDisposable(this._o.subscribe(new yl(n,this,t))),new k(i,t)},i}(e),vl=function(n){function i(t,i){this._o=t;this._p=i;n.call(this)}return t(i,n),i.prototype.next=function(n){this._p._open&&this._o.onNext(n)},i.prototype.error=function(n){this._o.onError(n)},i.prototype.onCompleted=function(){this._p._open&&this._o.onCompleted()},i}(f),yl=function(n){function i(t,i,r){this._o=t;this._p=i;this._r=r;n.call(this)}return t(i,n),i.prototype.next=function(){this._p._open=!0;this._r.dispose()},i.prototype.error=function(n){this._o.onError(n)},i.prototype.onCompleted=function(){this._r.dispose()},i}(f);i.skipUntil=function(n){return new al(this,n)};he=function(n){function u(t){this.source=t;n.call(this)}function i(n,t){this.o=n;this.inner=t;this.stopped=!1;this.latest=0;this.hasLatest=!1;f.call(this)}function r(n,t){this.parent=n;this.id=t;f.call(this)}return t(u,n),u.prototype.subscribeCore=function(n){var t=new w,r=this.source.subscribe(new i(n,t));return new k(r,t)},t(i,f),i.prototype.next=function(n){var t=new h,i=++this.latest;this.hasLatest=!0;this.inner.setDisposable(t);p(n)&&(n=y(n));t.setDisposable(n.subscribe(new r(this,i)))},i.prototype.error=function(n){this.o.onError(n)},i.prototype.completed=function(){this.stopped=!0;this.hasLatest||this.o.onCompleted()},t(r,f),r.prototype.next=function(n){this.parent.latest===this.id&&this.parent.o.onNext(n)},r.prototype.error=function(n){this.parent.latest===this.id&&this.parent.o.onError(n)},r.prototype.completed=function(){this.parent.latest===this.id&&(this.parent.hasLatest=!1,this.parent.stopped&&this.parent.o.onCompleted())},u}(e);i["switch"]=i.switchLatest=function(){return new he(this)};ce=function(n){function i(t,i){this.source=t;this.other=p(i)?y(i):i;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){return new k(this.source.subscribe(n),this.other.subscribe(new le(n)))},i}(e);le=function(n){function i(t){this._o=t;n.call(this)}return t(i,n),i.prototype.next=function(){this._o.onCompleted()},i.prototype.error=function(n){this._o.onError(n)},i.prototype.onCompleted=it,i}(f);i.takeUntil=function(n){return new ce(this,n)};var pl=function(n){function i(t,i,r){this._s=t;this._ss=i;this._cb=r;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){for(var i,f,e,o=this._ss.length,s={hasValue:gt(o,vi),hasValueAll:!1,values:new Array(o)},r=this._ss.length,u=new Array(r+1),t=0;t<r;t++)i=this._ss[t],f=new h,p(i)&&(i=y(i)),f.setDisposable(i.subscribe(new wl(n,t,s))),u[t]=f;return e=new h,e.setDisposable(this._s.subscribe(new bl(n,this._cb,s))),u[r]=e,new et(u)},i}(e),wl=function(n){function i(t,i,r){this._o=t;this._i=i;this._state=r;n.call(this)}return t(i,n),i.prototype.next=function(n){this._state.values[this._i]=n;this._state.hasValue[this._i]=!0;this._state.hasValueAll=this._state.hasValue.every(ht)},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=it,i}(f),bl=function(n){function i(t,i,r){this._o=t;this._cb=i;this._state=r;n.call(this)}return t(i,n),i.prototype.next=function(n){var i=[n].concat(this._state.values),t;if(this._state.hasValueAll){if(t=o(this._cb).apply(null,i),t===u)return this._o.onError(t.e);this._o.onNext(t)}},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._o.onCompleted()},i}(f);i.withLatestFrom=function(){var i,n,t,r;if(arguments.length===0)throw new Error("invalid arguments");for(i=arguments.length,n=new Array(i),t=0;t<i;t++)n[t]=arguments[t];return r=c(n[i-1])?n.pop():rr,Array.isArray(n[0])&&(n=n[0]),new pl(this,n,r)};ve=function(n){function i(t,i){this._s=t;this._cb=i;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){for(var i,u,r=this._s.length,f=new Array(r),e=gt(r,vi),o=gt(r,ae),t=0;t<r;t++)i=this._s[t],u=new h,f[t]=u,p(i)&&(i=y(i)),u.setDisposable(i.subscribe(new ye(n,t,this,o,e)));return new et(f)},i}(e);ye=function(n){function i(t,i,r,u,f){this._o=t;this._i=i;this._p=r;this._q=u;this._d=f;n.call(this)}function r(n){return n.length>0}function f(n){return n.shift()}function e(n){return function(t,i){return i!==n}}return t(i,n),i.prototype.next=function(n){if(this._q[this._i].push(n),this._q.every(r)){var i=this._q.map(f),t=o(this._p._cb).apply(null,i);if(t===u)return this._o.onError(t.e);this._o.onNext(t)}else this._d.filter(e(this._i)).every(ht)&&this._o.onCompleted()},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._d[this._i]=!0;this._d.every(ht)&&this._o.onCompleted()},i}(f);i.zip=function(){var i,n,t,r,u;if(arguments.length===0)throw new Error("invalid arguments");for(i=arguments.length,n=new Array(i),t=0;t<i;t++)n[t]=arguments[t];return r=c(n[i-1])?n.pop():rr,Array.isArray(n[0])&&(n=n[0]),u=this,n.unshift(u),new ve(n,r)};s.zip=function(){for(var i,r=arguments.length,n=new Array(r),t=0;t<r;t++)n[t]=arguments[t];return Array.isArray(n[0])&&(n=c(n[1])?n[0].concat(n[1]):n[0]),i=n.shift(),i.zip.apply(i,n)};pe=function(n){function i(t,i){this.sources=t;this._cb=i;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){for(var r=this.sources,t=r.length,u=new Array(t),f={q:gt(t,ae),done:gt(t,vi),cb:this._cb,o:n},i=0;i<t;i++)(function(n){var t=r[n],i=new h;(au(t)||lu(t))&&(t=kc(t));u[n]=i;i.setDisposable(t.subscribe(new we(f,n)))})(i);return new et(u)},i}(e);we=function(n){function i(t,i){this._s=t;this._i=i;n.call(this)}function r(n){return n.length>0}function f(n){return n.shift()}function e(n){return function(t,i){return i!==n}}return t(i,n),i.prototype.next=function(n){if(this._s.q[this._i].push(n),this._s.q.every(r)){var i=this._s.q.map(f),t=o(this._s.cb).apply(null,i);if(t===u)return this._s.o.onError(t.e);this._s.o.onNext(t)}else this._s.done.filter(e(this._i)).every(ht)&&this._s.o.onCompleted()},i.prototype.error=function(n){this._s.o.onError(n)},i.prototype.completed=function(){this._s.done[this._i]=!0;this._s.done.every(ht)&&this._s.o.onCompleted()},i}(f);i.zipIterable=function(){var i,n,t,r,u;if(arguments.length===0)throw new Error("invalid arguments");for(i=arguments.length,n=new Array(i),t=0;t<i;t++)n[t]=arguments[t];return r=c(n[i-1])?n.pop():rr,u=this,n.unshift(u),new pe(n,r)};i.asObservable=function(){return new d(kl(this),this)};be=function(n){function i(t){this.source=t;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){return this.source.subscribe(new ke(n))},i}(e);ke=function(n){function i(t){this._o=t;n.call(this)}return t(i,n),i.prototype.next=function(n){n.accept(this._o)},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._o.onCompleted()},i}(f);i.dematerialize=function(){return new be(this)};de=function(n){function i(t,i,r){this.source=t;this.keyFn=i;this.comparer=r;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){return this.source.subscribe(new ge(n,this.keyFn,this.comparer))},i}(e);ge=function(n){function i(t,i,r){this.o=t;this.keyFn=i;this.comparer=r;this.hasCurrentKey=!1;this.currentKey=null;n.call(this)}return t(i,n),i.prototype.next=function(n){var t=n,i;if(c(this.keyFn)&&(t=o(this.keyFn)(n),t===u))return this.o.onError(t.e);if(this.hasCurrentKey&&(i=o(this.comparer)(this.currentKey,t),i===u))return this.o.onError(i.e);if(!this.hasCurrentKey||!i){this.hasCurrentKey=!0;this.currentKey=t;this.o.onNext(n)}},i.prototype.error=function(n){this.o.onError(n)},i.prototype.completed=function(){this.o.onCompleted()},i}(f);i.distinctUntilChanged=function(n,t){return t||(t=gs),new de(this,n,t)};no=function(n){function r(t,i,r,u){this.source=t;this._oN=i;this._oE=r;this._oC=u;n.call(this)}function i(n,t){this.o=n;this.t=!t._oN||c(t._oN)?ai(t._oN||it,t._oE||it,t._oC||it):t._oN;this.isStopped=!1;f.call(this)}return t(r,n),r.prototype.subscribeCore=function(n){return this.source.subscribe(new i(n,this))},t(i,f),i.prototype.next=function(n){var t=o(this.t.onNext).call(this.t,n);if(t===u)this.o.onError(t.e);this.o.onNext(n)},i.prototype.error=function(n){var t=o(this.t.onError).call(this.t,n);if(t===u)return this.o.onError(t.e);this.o.onError(n)},i.prototype.completed=function(){var n=o(this.t.onCompleted).call(this.t);if(n===u)return this.o.onError(n.e);this.o.onCompleted()},r}(e);i["do"]=i.tap=i.doAction=function(n,t,i){return new no(this,n,t,i)};i.doOnNext=i.tapOnNext=function(n,t){return this.tap(typeof t!="undefined"?function(i){n.call(t,i)}:n)};i.doOnError=i.tapOnError=function(n,t){return this.tap(it,typeof t!="undefined"?function(i){n.call(t,i)}:n)};i.doOnCompleted=i.tapOnCompleted=function(n,t){return this.tap(it,null,typeof t!="undefined"?function(){n.call(t)}:n)};to=function(n){function i(t,i,r){this.source=t;this._fn=pt(i,r,0);n.call(this)}function r(n,t){this.isDisposed=!1;this._s=n;this._fn=t}return t(i,n),i.prototype.subscribeCore=function(n){var t=o(this.source.subscribe).call(this.source,n);return t===u&&(this._fn(),rt(t.e)),new r(t,this._fn)},r.prototype.dispose=function(){if(!this.isDisposed){var n=o(this._s.dispose).call(this._s);this._fn();n===u&&rt(n.e)}},i}(e);i["finally"]=function(n,t){return new to(this,n,t)};io=function(n){function r(t){this.source=t;n.call(this)}function i(n){this.o=n;this.isStopped=!1}return t(r,n),r.prototype.subscribeCore=function(n){return this.source.subscribe(new i(n))},i.prototype.onNext=it,i.prototype.onError=function(n){if(!this.isStopped){this.isStopped=!0;this.o.onError(n)}},i.prototype.onCompleted=function(){this.isStopped||(this.isStopped=!0,this.o.onCompleted())},i.prototype.dispose=function(){this.isStopped=!0},i.prototype.fail=function(n){if(!this.isStopped){this.isStopped=!0;this.observer.onError(n);return!0}return!1},r}(e);i.ignoreElements=function(){return new io(this)};ro=function(n){function i(t){this.source=t;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){return this.source.subscribe(new uo(n))},i}(e);uo=function(n){function i(t){this._o=t;n.call(this)}return t(i,n),i.prototype.next=function(n){this._o.onNext(ic(n))},i.prototype.error=function(n){this._o.onNext(rc(n));this._o.onCompleted()},i.prototype.completed=function(){this._o.onNext(uc());this._o.onCompleted()},i}(f);i.materialize=function(){return new ro(this)};i.repeat=function(n){return gr(this,n).concat()};i.retry=function(n){return gr(this,n).catchError()};i.retryWhen=function(n){return gr(this).catchErrorWhen(n)};fo=function(n){function i(t,i,r,u){this.source=t;this.accumulator=i;this.hasSeed=r;this.seed=u;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){return this.source.subscribe(new eo(n,this))},i}(e);eo=function(n){function i(t,i){this._o=t;this._p=i;this._fn=i.accumulator;this._hs=i.hasSeed;this._s=i.seed;this._ha=!1;this._a=null;this._hv=!1;this._i=0;n.call(this)}return t(i,n),i.prototype.next=function(n){if(this._hv||(this._hv=!0),this._ha?this._a=o(this._fn)(this._a,n,this._i,this._p):(this._a=this._hs?o(this._fn)(this._s,n,this._i,this._p):n,this._ha=!0),this._a===u)return this._o.onError(this._a.e);this._o.onNext(this._a);this._i++},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){!this._hv&&this._hs&&this._o.onNext(this._s);this._o.onCompleted()},i}(f);i.scan=function(){var n=!1,t,i=arguments[0];return arguments.length===2&&(n=!0,t=arguments[1]),new fo(this,i,n,t)};oo=function(n){function i(t,i){this.source=t;this._c=i;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){return this.source.subscribe(new so(n,this._c))},i}(e);so=function(n){function i(t,i){this._o=t;this._c=i;this._q=[];n.call(this)}return t(i,n),i.prototype.next=function(n){this._q.push(n);this._q.length>this._c&&this._o.onNext(this._q.shift())},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._o.onCompleted()},i}(f);i.skipLast=function(n){if(n<0)throw new kt;return new oo(this,n)};i.startWith=function(){var n,i=0;!!arguments.length&&v(arguments[0])?(n=arguments[0],i=1):n=ut;for(var r=[],t=i,u=arguments.length;t<u;t++)r.push(arguments[t]);return lf([dc(r,n),this]).concat()};ho=function(n){function i(t,i){this._o=t;this._c=i;this._q=[];n.call(this)}return t(i,n),i.prototype.next=function(n){this._q.push(n);this._q.length>this._c&&this._q.shift()},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){while(this._q.length>0)this._o.onNext(this._q.shift());this._o.onCompleted()},i}(f);i.takeLast=function(n){if(n<0)throw new kt;var t=this;return new d(function(i){return t.subscribe(new ho(i,n))},t)};i.flatMapConcat=i.concatMap=function(n,t,i){return new dr(this,n,t,i).merge(1)};iu=function(n){function i(t,i,r){this.source=t;this.selector=pt(i,r,3);n.call(this)}function e(n,t){return function(i,r,u){return n.call(this,t.selector(i,r,u),r,u)}}function r(n,t,i){this.o=n;this.selector=t;this.source=i;this.i=0;f.call(this)}return t(i,n),i.prototype.internalMap=function(n,t){return new i(this.source,e(n,this),t)},i.prototype.subscribeCore=function(n){return this.source.subscribe(new r(n,this.selector,this))},t(r,f),r.prototype.next=function(n){var t=o(this.selector)(n,this.i++,this.source);if(t===u)return this.o.onError(t.e);this.o.onNext(t)},r.prototype.error=function(n){this.o.onError(n)},r.prototype.completed=function(){this.o.onCompleted()},i}(e);i.map=i.select=function(n,t){var i=typeof n=="function"?n:function(){return n};return this instanceof iu?this.internalMap(i,t):new iu(this,i,t)};i.pluck=function(){var t=arguments.length,i=new Array(t),n;if(t===0)throw new Error("List of properties cannot be empty.");for(n=0;n<t;n++)i[n]=arguments[n];return this.map(dl(i,t))};i.flatMap=i.selectMany=function(n,t,i){return new dr(this,n,t,i).mergeAll()};r.Observable.prototype.flatMapLatest=function(n,t,i){return new dr(this,n,t,i).switchLatest()};co=function(n){function r(t,i){this.source=t;this._count=i;n.call(this)}function i(n,t){this._o=n;this._r=t;f.call(this)}return t(r,n),r.prototype.subscribeCore=function(n){return this.source.subscribe(new i(n,this._count))},t(i,f),i.prototype.next=function(n){if(this._r<=0)this._o.onNext(n);else this._r--},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._o.onCompleted()},r}(e);i.skip=function(n){if(n<0)throw new kt;return new co(this,n)};lo=function(n){function i(t,i){this.source=t;this._fn=i;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){return this.source.subscribe(new ao(n,this))},i}(e);ao=function(n){function i(t,i){this._o=t;this._p=i;this._i=0;this._r=!1;n.call(this)}return t(i,n),i.prototype.next=function(n){if(!this._r){var t=o(this._p._fn)(n,this._i++,this._p);if(t===u)return this._o.onError(t.e);this._r=!t}this._r&&this._o.onNext(n)},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._o.onCompleted()},i}(f);i.skipWhile=function(n,t){var i=pt(n,t,3);return new lo(this,i)};vo=function(n){function r(t,i){this.source=t;this._count=i;n.call(this)}function i(n,t){this._o=n;this._c=t;this._r=t;f.call(this)}return t(r,n),r.prototype.subscribeCore=function(n){return this.source.subscribe(new i(n,this._count))},t(i,f),i.prototype.next=function(n){if(this._r-->0){this._o.onNext(n);this._r<=0&&this._o.onCompleted()}},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._o.onCompleted()},r}(e);i.take=function(n,t){if(n<0)throw new kt;return n===0?ac(t):new vo(this,n)};yo=function(n){function i(t,i){this.source=t;this._fn=i;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){return this.source.subscribe(new po(n,this))},i}(e);po=function(n){function i(t,i){this._o=t;this._p=i;this._i=0;this._r=!0;n.call(this)}return t(i,n),i.prototype.next=function(n){if(this._r&&(this._r=o(this._p._fn)(n,this._i++,this._p),this._r===u))return this._o.onError(this._r.e);if(this._r)this._o.onNext(n);else this._o.onCompleted()},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._o.onCompleted()},i}(f);i.takeWhile=function(n,t){var i=pt(n,t,3);return new yo(this,i)};ru=function(n){function i(t,i,r){this.source=t;this.predicate=pt(i,r,3);n.call(this)}function e(n,t){return function(i,r,u){return t.predicate(i,r,u)&&n.call(this,i,r,u)}}function r(n,t,i){this.o=n;this.predicate=t;this.source=i;this.i=0;f.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){return this.source.subscribe(new r(n,this.predicate,this))},i.prototype.internalFilter=function(n,t){return new i(this.source,e(n,this),t)},t(r,f),r.prototype.next=function(n){var t=o(this.predicate)(n,this.i++,this.source);if(t===u)return this.o.onError(t.e);t&&this.o.onNext(n)},r.prototype.error=function(n){this.o.onError(n)},r.prototype.completed=function(){this.o.onCompleted()},i}(e);i.filter=i.where=function(n,t){return this instanceof ru?this.internalFilter(n,t):new ru(this,n,t)};s.fromCallback=function(n,t,i){return function(){var u,f,r;for(typeof t=="undefined"&&(t=this),u=arguments.length,f=new Array(u),r=0;r<u;r++)f[r]=arguments[r];return gl(n,t,i,f)}};s.fromNodeCallback=function(n,t,i){return function(){var u,f,r;for(typeof t=="undefined"&&(t=this),u=arguments.length,f=new Array(u),r=0;r<u;r++)f[r]=arguments[r];return ta(n,t,i,f)}};wo.prototype.dispose=function(){this.isDisposed||(this._e.removeEventListener(this._n,this._fn,!1),this.isDisposed=!0)};r.config.useNativeEvents=!1;ko=function(n){function i(t,i,r){this._el=t;this._n=i;this._fn=r;n.call(this)}function r(n,t){return function(){var i=arguments[0];if(c(t)&&(i=o(t).apply(null,arguments),i===u))return n.onError(i.e);n.onNext(i)}}return t(i,n),i.prototype.subscribeCore=function(n){return bo(this._el,this._n,r(n,this._fn))},i}(e);s.fromEvent=function(n,t,i){return n.addListener?go(function(i){n.addListener(t,i)},function(i){n.removeListener(t,i)},i):!r.config.useNativeEvents&&typeof n.on=="function"&&typeof n.off=="function"?go(function(i){n.on(t,i)},function(i){n.off(t,i)},i):new ko(n,t,i).publish().refCount()};var ua=function(n){function i(t,i,r){this._add=t;this._del=i;this._fn=r;n.call(this)}function f(n,t){return function(){var i=arguments[0];if(c(t)&&(i=o(t).apply(null,arguments),i===u))return n.onError(i.e);n.onNext(i)}}function r(n,t,i){this._del=n;this._fn=t;this._ret=i;this.isDisposed=!1}return t(i,n),i.prototype.subscribeCore=function(n){var t=f(n,this._fn),i=this._add(t);return new r(this._del,t,i)},r.prototype.dispose=function(){this.isDisposed||c(this._del)&&this._del(this._fn,this._ret)},i}(e),go=s.fromEventPattern=function(n,t,i){return new ua(n,t,i).publish().refCount()},fa=function(n){function i(t,i){this._p=t;this._s=i;n.call(this)}function r(n,t){var i=t[0],r=t[1];i.onNext(r);i.onCompleted()}function u(n,t){var i=t[0],r=t[1];i.onError(r)}return t(i,n),i.prototype.subscribeCore=function(n){var t=new h,i=this;return this._p.then(function(u){t.setDisposable(i._s.schedule([n,u],r))},function(r){t.setDisposable(i._s.schedule([n,r],u))}),t},i}(e),y=s.fromPromise=function(n,t){return t||(t=st),new fa(n,t)};i.toPromise=function(n){if(n||(n=r.config.Promise),!n)throw new dt("Promise type not provided nor in Rx.config.Promise");var t=this;return new n(function(n,i){var r;t.subscribe(function(n){r=n},i,function(){n(r)})})};s.startAsync=function(n){var t=o(n)();return t===u?ei(t.e):y(t)};ns=function(n){function i(t,i,r){this.source=t;this._fn1=i;this._fn2=r;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){var t=this.source.multicast(this._fn1());return new k(this._fn2(t).subscribe(n),t.connect())},i}(e);i.multicast=function(n,t){return c(n)?new ns(this,n,t):new oa(this,n)};i.publish=function(n){return n&&c(n)?this.multicast(function(){return new bt},n):this.multicast(new bt)};i.share=function(){return this.publish().refCount()};i.publishLast=function(n){return n&&c(n)?this.multicast(function(){return new er},n):this.multicast(new er)};i.publishValue=function(n,t){return arguments.length===2?this.multicast(function(){return new ws(t)},n):this.multicast(new ws(n))};i.shareValue=function(n){return this.publishValue(n).refCount()};i.replay=function(n,t,i,r){return n&&c(n)?this.multicast(function(){return new bs(t,i,r)},n):this.multicast(new bs(t,i,r))};i.shareReplay=function(n,t,i){return this.replay(null,n,t,i).refCount()};var ea=function(n){function i(t){this.source=t;this._count=0;this._connectableSubscription=null;n.call(this)}function r(n,t){this._p=n;this._s=t;this.isDisposed=!1}return t(i,n),i.prototype.subscribeCore=function(n){var t=this.source.subscribe(n);return++this._count==1&&(this._connectableSubscription=this.source.connect()),new r(this,t)},r.prototype.dispose=function(){this.isDisposed||(this.isDisposed=!0,this._s.dispose(),--this._p._count==0&&this._p._connectableSubscription.dispose())},i}(e),oa=r.ConnectableObservable=function(n){function i(t,i){this.source=t;this._connection=null;this._source=t.asObservable();this._subject=i;n.call(this)}function r(n,t){this._p=n;this._s=t}return t(i,n),r.prototype.dispose=function(){this._s&&(this._s.dispose(),this._s=null,this._p._connection=null)},i.prototype.connect=function(){if(!this._connection){var n=this._source.subscribe(this._subject);this._connection=new r(this,n)}return this._connection},i.prototype._subscribe=function(n){return this._subject.subscribe(n)},i.prototype.refCount=function(){return new ea(this)},i}(s),sa=function(n){function i(t,i){this._dt=t;this._s=i;n.call(this)}function r(n,t){t.onNext(0);t.onCompleted()}return t(i,n),i.prototype.subscribeCore=function(n){return this._s.scheduleFuture(n,this._dt,r)},i}(e);rs=s.interval=function(n,t){return is(n,n,v(t)?t:st)};ca=s.timer=function(t,i,r){var u;return(v(r)||(r=st),i!=null&&typeof i=="number"?u=i:v(i)&&(r=i),(t instanceof Date||typeof t=="number")&&u===n)?ha(t,r):t instanceof Date&&u!==n?ts(t.getTime(),i,r):is(t,u,r)};i.delay=function(){var n=arguments[0],i,t;if(typeof n=="number"||n instanceof Date)return i=n,t=arguments[1],v(t)||(t=st),i instanceof Date?la(this,i,t):us(this,i,t);if(s.isObservable(n)||c(n))return aa(this,n,arguments[1]);throw new Error("Invalid arguments");};fs=function(n){function i(t,i,r){v(r)||(r=st);this.source=t;this._dt=i;this._s=r;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){var t=new w;return new k(this.source.subscribe(new es(n,this.source,this._dt,this._s,t)),t)},i}(e);es=function(n){function i(t,i,r,u,f){this._o=t;this._s=i;this._d=r;this._scheduler=u;this._c=f;this._v=null;this._hv=!1;this._id=0;n.call(this)}return t(i,n),i.prototype.next=function(n){this._hv=!0;this._v=n;var i=++this._id,t=new h;this._c.setDisposable(t);t.setDisposable(this._scheduler.scheduleFuture(this,this._d,function(t,r){r._hv&&r._id===i&&r._o.onNext(n);r._hv=!1}))},i.prototype.error=function(n){this._c.dispose();this._o.onError(n);this._hv=!1;this._id++},i.prototype.completed=function(){this._c.dispose();this._hv&&this._o.onNext(this._v);this._o.onCompleted();this._hv=!1;this._id++},i}(f);i.debounce=function(){if(c(arguments[0]))return va(this,arguments[0]);if(typeof arguments[0]=="number")return new fs(this,arguments[0],arguments[1]);throw new Error("Invalid arguments");};os=function(n){function i(t,i){this.source=t;this._s=i;n.call(this)}return t(i,n),i.prototype.subscribeCore=function(n){return this.source.subscribe(new ss(n,this._s))},i}(e);ss=function(n){function i(t,i){this._o=t;this._s=i;n.call(this)}return t(i,n),i.prototype.next=function(n){this._o.onNext({value:n,timestamp:this._s.now()})},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._o.onCompleted()},i}(f);i.timestamp=function(n){return v(n)||(n=st),new os(this,n)};i.sample=i.throttleLatest=function(n,t){return v(t)||(t=st),typeof n=="number"?hs(this,rs(n,t)):hs(this,n)};yi=r.TimeoutError=function(n){this.message=n||"Timeout has occurred";this.name="TimeoutError";Error.call(this)};yi.prototype=Object.create(Error.prototype);i.timeout=function(){var n=arguments[0];if(n instanceof Date||typeof n=="number")return pa(this,n,arguments[1],arguments[2]);if(s.isObservable(n)||c(n))return ya(this,n,arguments[1],arguments[2]);throw new Error("Invalid arguments");};i.throttle=function(n,t){var i,r;if(v(t)||(t=st),i=+n||0,i<=0)throw new RangeError("windowDuration cannot be less or equal zero.");return r=this,new d(function(n){var u=0;return r.subscribe(function(r){var f=t.now();if(u===0||f-u>=i){u=f;n.onNext(r)}},function(t){n.onError(t)},function(){n.onCompleted()})},r)};cs=function(n){function i(t,i){this.source=t;this.controller=new bt;this.pauser=i&&i.subscribe?this.controller.merge(i):this.controller;n.call(this)}return t(i,n),i.prototype._subscribe=function(n){var i=this.source.publish(),r=i.subscribe(n),t=nt,u=this.pauser.distinctUntilChanged().subscribe(function(n){n?t=i.connect():(t.dispose(),t=nt)});return new et([r,t,u])},i.prototype.pause=function(){this.controller.onNext(!1)},i.prototype.resume=function(){this.controller.onNext(!0)},i}(s);i.pausable=function(n){return new cs(this,n)};ls=function(i){function r(n,t){this.source=n;this.controller=new bt;this.pauser=t&&t.subscribe?this.controller.merge(t):this.controller;i.call(this)}return t(r,i),r.prototype._subscribe=function(t){function u(){while(r.length>0)t.onNext(r.shift())}var r=[],i;return wa(this.source,this.pauser.startWith(!1).distinctUntilChanged(),function(n,t){return{data:n,shouldFire:t}}).subscribe(function(f){if(i!==n&&f.shouldFire!==i)i=f.shouldFire,f.shouldFire&&u();else if(i=f.shouldFire,f.shouldFire)t.onNext(f.data);else r.push(f.data)},function(n){u();t.onError(n)},function(){u();t.onCompleted()})},r.prototype.pause=function(){this.controller.onNext(!1)},r.prototype.resume=function(){this.controller.onNext(!0)},r}(s);i.pausableBuffered=function(n){return new ls(this,n)};as=function(n){function i(t,i,r){n.call(this);this.subject=new vs(i,r);this.source=t.multicast(this.subject).refCount()}return t(i,n),i.prototype._subscribe=function(n){return this.source.subscribe(n)},i.prototype.request=function(n){return this.subject.request(n==null?-1:n)},i}(s);vs=function(n){function i(t,i){t==null&&(t=!0);n.call(this);this.subject=new bt;this.enableQueue=t;this.queue=t?[]:null;this.requestedCount=0;this.requestedDisposable=null;this.error=null;this.hasFailed=!1;this.hasCompleted=!1;this.scheduler=i||tt}return t(i,n),ri(i.prototype,wt,{_subscribe:function(n){return this.subject.subscribe(n)},onCompleted:function(){this.hasCompleted=!0;this.enableQueue&&this.queue.length!==0?this.queue.push(vt.createOnCompleted()):(this.subject.onCompleted(),this.disposeCurrentRequest())},onError:function(n){if(this.hasFailed=!0,this.error=n,this.enableQueue&&this.queue.length!==0)this.queue.push(vt.createOnError(n));else{this.subject.onError(n);this.disposeCurrentRequest()}},onNext:function(n){if(this.requestedCount<=0)this.enableQueue&&this.queue.push(vt.createOnNext(n));else{this.requestedCount--==0&&this.disposeCurrentRequest();this.subject.onNext(n)}},_processRequest:function(n){if(this.enableQueue)while(this.queue.length>0&&(n>0||this.queue[0].kind!=="N")){var t=this.queue.shift();t.accept(this.subject);t.kind==="N"?n--:(this.disposeCurrentRequest(),this.queue=[])}return n},request:function(n){this.disposeCurrentRequest();var t=this;return this.requestedDisposable=this.scheduler.schedule(n,function(n,i){var r=t._processRequest(i),u=t.hasCompleted||t.hasFailed;if(!u&&r>0)return t.requestedCount=r,ui(function(){t.requestedCount=0})}),this.requestedDisposable},disposeCurrentRequest:function(){this.requestedDisposable&&(this.requestedDisposable.dispose(),this.requestedDisposable=null)}}),i}(s);i.controlled=function(n,t){return n&&v(n)&&(t=n,n=!0),n==null&&(n=!0),new as(this,n,t)};i.pipe=function(n){function i(){t.resume()}var t=this.pausableBuffered();return n.addListener("drain",i),t.subscribe(function(i){n.write(String(i))||t.pause()},function(t){n.emit("error",t)},function(){n._isStdio||n.end();n.removeListener("drain",i)}),t.resume(),n};ys=function(n){function i(t,i){this._o=t;this._xform=i;n.call(this)}return t(i,n),i.prototype.next=function(n){var t=o(this._xform["@@transducer/step"]).call(this._xform,this._o,n);if(t===u)this._o.onError(t.e)},i.prototype.error=function(n){this._o.onError(n)},i.prototype.completed=function(){this._xform["@@transducer/result"](this._o)},i}(f);i.transduce=function(n){var t=this;return new d(function(i){var r=n(ba(i));return t.subscribe(new ys(i,r))},t)};var d=r.AnonymousObservable=function(n){function f(n){return n&&c(n.dispose)?n:c(n)?ui(n):nt}function r(n,t){var i=t[0],r=t[1],e=o(r.__subscribe).call(r,i);e!==u||i.fail(u.e)||rt(u.e);i.setDisposable(f(e))}function i(t,i){this.source=i;this.__subscribe=t;n.call(this)}return t(i,n),i.prototype._subscribe=function(n){var t=new ps(n),i=[t,this];return tt.scheduleRequired()?tt.schedule(i,r):r(null,i),t},i}(s),ps=function(n){function r(t){n.call(this);this.observer=t;this.m=new h}t(r,n);var i=r.prototype;return i.next=function(n){var t=o(this.observer.onNext).call(this.observer,n);t===u&&(this.dispose(),rt(t.e))},i.error=function(n){var t=o(this.observer.onError).call(this.observer,n);this.dispose();t===u&&rt(t.e)},i.completed=function(){var n=o(this.observer.onCompleted).call(this.observer);this.dispose();n===u&&rt(n.e)},i.setDisposable=function(n){this.m.setDisposable(n)},i.getDisposable=function(){return this.m.getDisposable()},i.dispose=function(){n.prototype.dispose.call(this);this.m.dispose()},r}(f),fr=function(n,t){this._s=n;this._o=t};fr.prototype.dispose=function(){if(!this._s.isDisposed&&this._o!==null){var n=this._s.observers.indexOf(this._o);this._s.observers.splice(n,1);this._o=null}};var bt=r.Subject=function(n){function i(){n.call(this);this.isDisposed=!1;this.isStopped=!1;this.observers=[];this.hasError=!1}return t(i,n),ri(i.prototype,wt.prototype,{_subscribe:function(n){if(b(this),!this.isStopped)return this.observers.push(n),new fr(this,n);if(this.hasError){n.onError(this.error);return nt}return n.onCompleted(),nt},hasObservers:function(){return this.observers.length>0},onCompleted:function(){if(b(this),!this.isStopped){this.isStopped=!0;for(var n=0,t=ft(this.observers),i=t.length;n<i;n++)t[n].onCompleted();this.observers.length=0}},onError:function(n){if(b(this),!this.isStopped){this.isStopped=!0;this.error=n;this.hasError=!0;for(var t=0,i=ft(this.observers),r=i.length;t<r;t++)i[t].onError(n);this.observers.length=0}},onNext:function(n){if(b(this),!this.isStopped)for(var t=0,i=ft(this.observers),r=i.length;t<r;t++)i[t].onNext(n)},dispose:function(){this.isDisposed=!0;this.observers=null}}),i.create=function(n,t){return new ka(n,t)},i}(s),er=r.AsyncSubject=function(n){function i(){n.call(this);this.isDisposed=!1;this.isStopped=!1;this.hasValue=!1;this.observers=[];this.hasError=!1}return t(i,n),ri(i.prototype,wt.prototype,{_subscribe:function(n){if(b(this),!this.isStopped)return this.observers.push(n),new fr(this,n);if(this.hasError)n.onError(this.error);else if(this.hasValue){n.onNext(this.value);n.onCompleted()}else n.onCompleted();return nt},hasObservers:function(){return b(this),this.observers.length>0},onCompleted:function(){var n,t,i,r;if(b(this),!this.isStopped){if(this.isStopped=!0,t=ft(this.observers),i=t.length,this.hasValue)for(n=0;n<i;n++){r=t[n];r.onNext(this.value);r.onCompleted()}else for(n=0;n<i;n++)t[n].onCompleted();this.observers.length=0}},onError:function(n){if(b(this),!this.isStopped){this.isStopped=!0;this.hasError=!0;this.error=n;for(var t=0,i=ft(this.observers),r=i.length;t<r;t++)i[t].onError(n);this.observers.length=0}},onNext:function(n){(b(this),this.isStopped)||(this.value=n,this.hasValue=!0)},dispose:function(){this.isDisposed=!0;this.observers=null;this.error=null;this.value=null}}),i}(s),ka=r.AnonymousSubject=function(n){function i(t,i){this.observer=t;this.observable=i;n.call(this)}return t(i,n),ri(i.prototype,wt.prototype,{_subscribe:function(n){return this.observable.subscribe(n)},onCompleted:function(){this.observer.onCompleted()},onError:function(n){this.observer.onError(n)},onNext:function(n){this.observer.onNext(n)}}),i}(s),ws=r.BehaviorSubject=function(n){function i(t){n.call(this);this.value=t;this.observers=[];this.isDisposed=!1;this.isStopped=!1;this.hasError=!1}return t(i,n),ri(i.prototype,wt.prototype,{_subscribe:function(n){if(b(this),!this.isStopped){this.observers.push(n);n.onNext(this.value);return new fr(this,n)}if(this.hasError)n.onError(this.error);else n.onCompleted();return nt},getValue:function(){return b(this),this.hasError&&rt(this.error),this.value},hasObservers:function(){return this.observers.length>0},onCompleted:function(){if(b(this),!this.isStopped){this.isStopped=!0;for(var n=0,t=ft(this.observers),i=t.length;n<i;n++)t[n].onCompleted();this.observers.length=0}},onError:function(n){if(b(this),!this.isStopped){this.isStopped=!0;this.hasError=!0;this.error=n;for(var t=0,i=ft(this.observers),r=i.length;t<r;t++)i[t].onError(n);this.observers.length=0}},onNext:function(n){if(b(this),!this.isStopped){this.value=n;for(var t=0,i=ft(this.observers),r=i.length;t<r;t++)i[t].onNext(n)}},dispose:function(){this.isDisposed=!0;this.observers=null;this.value=null;this.error=null}}),i}(s),bs=r.ReplaySubject=function(n){function u(n,t){return ui(function(){t.dispose();n.isDisposed||n.observers.splice(n.observers.indexOf(t),1)})}function i(t,i,u){this.bufferSize=t==null?r:t;this.windowSize=i==null?r:i;this.scheduler=u||tt;this.q=[];this.observers=[];this.isStopped=!1;this.isDisposed=!1;this.hasError=!1;this.error=null;n.call(this)}var r=Math.pow(2,53)-1;return t(i,n),ri(i.prototype,wt.prototype,{_subscribe:function(n){var t,r,i,f;for(b(this),t=new ec(this.scheduler,n),r=u(this,t),this._trim(this.scheduler.now()),this.observers.push(t),i=0,f=this.q.length;i<f;i++)t.onNext(this.q[i].value);if(this.hasError)t.onError(this.error);else this.isStopped&&t.onCompleted();return t.ensureActive(),r},hasObservers:function(){return this.observers.length>0},_trim:function(n){while(this.q.length>this.bufferSize)this.q.shift();while(this.q.length>0&&n-this.q[0].interval>this.windowSize)this.q.shift()},onNext:function(n){var t,r;if(b(this),!this.isStopped){t=this.scheduler.now();this.q.push({interval:t,value:n});this._trim(t);for(var i=0,u=ft(this.observers),f=u.length;i<f;i++){r=u[i];r.onNext(n);r.ensureActive()}}},onError:function(n){var r,i;if(b(this),!this.isStopped){this.isStopped=!0;this.error=n;this.hasError=!0;r=this.scheduler.now();this._trim(r);for(var t=0,u=ft(this.observers),f=u.length;t<f;t++){i=u[t];i.onError(n);i.ensureActive()}this.observers.length=0}},onCompleted:function(){var i,t;if(b(this),!this.isStopped){this.isStopped=!0;i=this.scheduler.now();this._trim(i);for(var n=0,r=ft(this.observers),u=r.length;n<u;n++)t=r[n],t.onCompleted(),t.ensureActive();this.observers.length=0}},dispose:function(){this.isDisposed=!0;this.observers=null}}),i}(s);r.Pauser=function(n){function i(){n.call(this)}return t(i,n),i.prototype.pause=function(){this.onNext(!1)},i.prototype.resume=function(){this.onNext(!0)},i}(bt);typeof define=="function"&&typeof define.amd=="object"&&define.amd?(l.Rx=r,define(function(){return r})):si&&hi?fu?(hi.exports=r).Rx=r:si.Rx=r:l.Rx=r;ks=hu()}.call(this);
/**
 * @license
